package com.sulake.core.assets.loaders
{
   ...
   public class BitmapFileLoader extends AssetLoaderEventBroker implements IAssetLoader
   {
      ...
      public function BitmapFileLoader(param1:String, param2:URLRequest = null)
      {
         ...
         this.var_937 = new LoaderContext();
         this.var_937.checkPolicyFile = true;
         ...
         {
            this.var_36.load(param2,this.var_937);
         }
      }
      ...
      public function load(param1:URLRequest) : void
      {
         ...
         var_288 = 0;
         this.var_36.load(param1,this.var_937);
      }
      ...
      override protected function retry() : Boolean
      {
         if(!_disposed)
         {
            if(++var_288 < var_2624)
            {
               ...
               this.var_36.load(new URLRequest(this.var_936 + (this.var_936.indexOf("?") == -1 ? "?" : "&") + "retry=" + var_288),this.var_937);
               return true;
            }
         }
         return false;

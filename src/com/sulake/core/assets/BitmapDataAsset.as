package com.sulake.core.assets
{
   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      protected static var var_516:uint = 0;
      
      protected static var var_433:uint = 0;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_433 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_112 is BitmapDataAsset)
         {
            ...
            this.var_1383 = BitmapDataAsset(this.var_112).var_1383;
            this.var_1382 = BitmapDataAsset(this.var_112).var_1382;
            if(this._bitmap != null)
            {
               this.var_112 = null;
               return;

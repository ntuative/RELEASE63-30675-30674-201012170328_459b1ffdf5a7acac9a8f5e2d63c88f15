package com.sulake.core.window
{
   ...
   public class WindowModel implements IDisposable
   {
      ...
      protected var var_513:uint;
      
      protected var var_417:uint = 10;
      
      protected var var_768:Boolean = true;
      ...
      public function WindowModel(param1:uint, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:Array = null)
      {
         ...
         this.var_79 = param4;
         this.var_769 = param8 == null ? new Array() : param8;
         this.var_16 = param6;
         this.var_11 = param7.clone();
         this.var_351 = param7.clone();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            this.var_11 = null;
            this.var_16 = null;
            this._state = WindowState.const_486;
            this.var_769 = null;
         }
      }
      ...
      {
         return this.var_351.width;
      }
      
      public function getInitialHeight() : int
      {
         return this.var_351.height;
      }

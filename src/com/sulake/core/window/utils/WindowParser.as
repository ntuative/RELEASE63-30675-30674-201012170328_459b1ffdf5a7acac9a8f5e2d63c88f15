package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1016:String = "_EXCLUDE";
      
      public static const const_1638:String = "_INCLUDE";
      
      public static const const_1755:String = "_TEMP";
      
      private static const const_1246:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1247:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var _typeStringToCodeTable:Dictionary;
      
      protected var var_1178:Dictionary;
      
      protected var var_939:Dictionary;
      
      protected var var_1427:Dictionary;
      
      protected var var_1907:Map;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         this.var_1178 = new Dictionary();
         TypeCodeTable.fillTables(this._typeStringToCodeTable,this.var_1178);
         this.var_939 = new Dictionary();
         this.var_1427 = new Dictionary();
         ParamCodeTable.fillTables(this.var_939,this.var_1427);
         this.var_1907 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1247,"");
         return param1.replace(const_1246,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            ...
            for(_loc1_ in this.var_1178)
            {
               delete this.var_1178[_loc1_];
            }
            for(_loc1_ in this.var_939)
            {
               delete this.var_939[_loc1_];
            }
            for(_loc1_ in this.var_1427)
            {
               delete this.var_1427[_loc1_];
            }
            this.var_1907.dispose();
            this.var_1907 = null;
            this.var_16 = null;
            this._disposed = true;
         }
      ...
      public function windowToXMLString(param1:IWindow) : String
      {
         ...
         var _loc2_:String = "";
         var _loc3_:String = this.var_1178[param1.type];
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1016) == -1)
                  {

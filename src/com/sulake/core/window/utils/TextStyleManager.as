package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      public static const const_319:String = "regular";
      ...
      private static var var_215:IEventDispatcher;
      
      private static const TAG_OPEN:String = "{";
      
      private static const const_546:String = "}";
      
      private static const const_1156:String = "/*";
      
      private static const const_1155:String = "*/";
      ...
      private static function init() : void
      {
         var _loc1_:* = null;
         var_81 = new Map();
         var_215 = new EventDispatcher();
         _loc1_ = new TextStyle();
         _loc1_.name = const_319;
         _loc1_.color = 0;
         _loc1_.fontSize = "9";
      ...
      public static function setStyle(param1:String, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            var_215.dispatchEvent(new Event(Event.ADDED));
         }
         else
         {
            var_215.dispatchEvent(new Event(Event.CHANGE));
         }
      }
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_81[const_319],var_81[ITALIC],var_81[BOLD]];
            var_81.reset();
            var_81[const_319] = _loc5_[0];
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         var _loc4_:Array = _loc3_.split(const_546);
         if(countSubStrings(param1,TAG_OPEN) != countSubStrings(param1,const_546))
         {
            throw new Error("Mismatching amount of \"" + TAG_OPEN + "\" versus \"" + const_546 + "\", please check the CSS!");
         }
         for each(_loc5_ in _loc4_)
         {
            while(_loc5_.indexOf(const_1156) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1155) + 2,_loc5_.length);
            }

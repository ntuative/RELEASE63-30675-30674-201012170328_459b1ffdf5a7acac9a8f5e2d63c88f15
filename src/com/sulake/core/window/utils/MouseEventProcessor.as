package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected var var_136:IWindowRenderer;
      
      protected var var_129:IDesktopWindow;
      
      protected var var_766:IWindowContextStateListener;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_78 = param1.var_1158 as WindowController;
         this._lastClickTarget = param1.var_1157 as WindowController;
         this.var_136 = param1.renderer;
         this.var_766 = param1.var_1156;
         param2.begin();
         ...
         while(true)
         {
            ...
            if(_loc3_.stageX != this.var_625.x || _loc3_.stageY != this.var_625.y)
            {
               this.var_625.x = _loc3_.stageX;
               this.var_625.y = _loc3_.stageY;
               _loc6_ = new Array();
               this.var_129.groupParameterFilteredChildrenUnderPoint(this.var_625,_loc6_,WindowParam.const_28);
            }
            ...
            if(_loc4_ == 0)
            {
               ...
               {
                  if(this.var_78 != this.var_129 && !this.var_78.disposed)
                  {
                     ...
                     this.var_78 = WindowController(this.var_129);
                  }
               }
            }
            while(--_loc4_ > -1)
               ...
               if(_loc5_ != null && _loc5_.visible)
               {
                  ...
                  else if(_loc3_.type == MouseEvent.MOUSE_UP || _loc3_.type == MouseEvent.CLICK)
                  {
                     if(this.var_78 && !this.var_78.disposed)
                     {
                        ...
                        {
                           this.var_766.mouseEventReceived(_loc3_.type,this.var_78);
                        }
                     }
                  }
         ...
         param1.var_1158 = this.var_78;
         param1.var_1157 = this._lastClickTarget;
         param1.renderer = this.var_136;
         param1.var_1156 = this.var_766;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         var _loc5_:BitmapData = this.var_136.getDrawBufferForRenderable(param1);
         if(!param1.validateLocalPointIntersection(_loc4_,_loc5_))
         {
            return null;
         }
         if(param1.testParamFlag(WindowParam.const_507))
         {

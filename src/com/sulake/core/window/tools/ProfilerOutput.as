package com.sulake.core.window.tools
{
   ...
   public class ProfilerOutput implements IDevTool
   {
      ...
      private static var var_1344:Class = ProfilerOutput_profiler_dialog_xml;
      
      private static var var_1345:Class = ProfilerOutput_profiler_task_xml;
       
      
      private var _disposed:Boolean = false;
      
      private var var_144:IProfiler;
      ...
      public function ProfilerOutput(param1:IContext, param2:ICoreWindowManager, param3:IWindowRenderer)
      {
         ...
         this.var_2662 = new Array();
         this.var_144 = this.profiler;
         this._windowManager = param2;
         this._windowRenderer = param3;
         var _loc4_:ByteArray = new var_1344() as ByteArray;
      ...
      public function set profiler(param1:IProfiler) : void
      {
         if(this.var_144)
         {
            this.var_144.removeStopEventListener(this.refresh);
            this.var_144 = null;
         }
         if(!this.var_144 && param1)
         {
            this.var_144 = param1;
            this.var_144.addStopEventListener(this.refresh);
         }
      }
      ...
      private function profilerWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param2.name == "footer_enable_toggle")
         {
            ...
            else if(param1.type == WindowEvent.const_761)
            {
               this.var_1744 = false;
               ITextWindow(this._window.findChildByName("footer")).textColor = 4284900966;
            }
      ...
      {
         var _loc2_:Array = this.var_144.getProfilerAgentsInArray();
         ...
         if(this.var_1744)
         {
            ITextWindow(this._window.findChildByName("footer")).text = "Assets - Libraries: " + this.var_144.numAssetLibraryInstances + " " + "Bitmaps: " + this.var_144.numBitmapAssetInstances + " / " + this.var_144.numAllocatedBitmapDataBytes + " bytes \n" + "Windows - Allocated bitmap data: " + (this._windowRenderer.allocatedByteCount + GraphicContext.allocatedByteCount) + " bytes \n" + "Tracked bitmap data: " + this.var_144.numTrackedBitmapDataInstances + " / " + this.var_144.numTrackedBitmapDataBytes + " bytes";
         }
      }
      ...
      {
         var _loc2_:ByteArray = new var_1345() as ByteArray;

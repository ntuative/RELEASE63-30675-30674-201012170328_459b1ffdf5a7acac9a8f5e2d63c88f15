package com.sulake.core.window.services
{
   ...
   public class GestureAgentService implements IGestureAgentService, IDisposable
   {
      ...
      protected var var_181:Timer;
      
      protected var var_1423:uint = 0;
      ...
      public function begin(param1:IWindow, param2:Function, param3:uint, param4:int, param5:int) : IWindow
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            this.var_181 = new Timer(40,0);
            this.var_181.addEventListener(TimerEvent.TIMER,this.operate);
            this.var_181.start();
         }
         return _loc6_;
      }
      ...
      protected function operate(param1:TimerEvent) : void
      {
         ...
         else if(this.var_254 != null)
         {
            this.var_254(this.var_1172,this.var_1171);
         }
      }
      ...
      public function end(param1:IWindow) : IWindow
      {
         ...
         {
            this.var_181.stop();
            this.var_181.removeEventListener(TimerEvent.TIMER,this.operate);
            this.var_181 = null;
         }
         if(this._working)
         {

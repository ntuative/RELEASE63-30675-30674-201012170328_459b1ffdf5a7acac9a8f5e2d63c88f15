package com.sulake.core.window.components
{
   ...
   public class SelectorController extends InteractiveController implements ISelectorWindow, IIterable
   {
      ...
      protected var var_1889:Boolean = true;
      ...
      {
         if(param2.type == WindowNotifyEvent.const_238)
         {
         ...
         if(param1 != null)
         {
            if(param1 != this.var_184)
            {
               ...
               if(getChildIndex(param1) > -1)
               {
                  ...
                  notifyEventListeners(new WindowNotifyEvent(WindowNotifyEvent.const_341,this,this.var_184));
               }
            }
         }
      }

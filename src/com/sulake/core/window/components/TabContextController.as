package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1213:String = "_SELECTOR";
      
      private static const const_1212:String = "_CONTENT";
       
      
      protected var var_938:ITabSelectorWindow;
      
      protected var var_1905:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_938 = findChildByTag(const_1213) as ITabSelectorWindow;
            if(this.var_938 != null)
            {
               this.var_938.procedure = this.selectorEventProc;
            }
         }
         return this.var_938;
      }
      ...
      public function get container() : IWindowContainer
      {
         ...
         {
            this.var_1905 = findChildByTag(const_1212) as IWindowContainer;
         }
      ...
      {
         return !!this.var_645 ? this.selector.iterator : null;
      }
      
      public function get numTabItems() : uint
      {
         return this.var_938.numSelectables;
      }

package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1196:String = "increment";
      
      private static const const_1197:String = "decrement";
      
      private static const const_859:String = "slider_track";
      
      private static const const_550:String = "slider_bar";
       
      
      protected var _offset:Number = 0;
      
      protected var var_624:Number = 0.1;
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_19 != null && !this.var_19.disposed)
         {
            ...
            this.var_19.removeEventListener(WindowEvent.const_491,this.onScrollableScrolled);
         }
         this.var_19 = param1;
         if(this.var_19 != null && !this.var_19.disposed)
         {
            this.var_19.addEventListener(WindowEvent.const_44,this.onScrollableResized);
            this.var_19.addEventListener(WindowEvent.const_491,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_844 = _loc3_.value as String;
            }
            _loc4_++;
         }
      ...
      {
         return findChildByName(const_859) as WindowController;
      }
      
      protected function get lift() : WindowController
      {
         return this.track.findChildByName(const_550) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:Event) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_550:
         ...
         if(param2.type == WindowNotifyEvent.const_428)
         {
            if(this.var_19 == null)
            {
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_269)
            {
               if(WindowMouseEvent(param2).delta > 0)
               {
                  if(this._horizontal)
                  {
                     this.scrollH -= this.var_624;
                  }
                  else
                  {
                     this.scrollV -= this.var_624;
                  }
               }
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_38 || param1.type == WindowTouchEvent.const_518)
         {
            ...
            else if(param2.name == const_1197)
            {
               if(this.var_19)
               {
                  this.var_1071 = true;
            ...
            else if(param2.name == const_859)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_550).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.const_269)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_844) as IScrollableWindow;
            if(_loc1_ == null && var_13 is IWindowContainer)
            {
               _loc1_ = IWindowContainer(var_13).findChildByName(this.var_844) as IScrollableWindow;
               if(_loc1_)
               {

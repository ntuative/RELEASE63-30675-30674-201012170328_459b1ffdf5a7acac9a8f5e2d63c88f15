package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1048:IItemListWindow;
      
      private var var_376:IScrollbarWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_376)
         {
            this.var_376.removeEventListener(WindowEvent.const_285,this.scrollBarEventProc);
            this.var_376.removeEventListener(WindowEvent.const_205,this.scrollBarEventProc);
            this.var_376 = null;
         }
         if(this.var_1048)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1048)
         {
            this.var_1048 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_376)
         {
            this.var_376 = findChildByTag("_SCROLLBAR") as IScrollbarWindow;
            if(this.var_376)
            {
               this.var_376.addEventListener(WindowEvent.const_285,this.scrollBarEventProc);
               this.var_376.addEventListener(WindowEvent.const_205,this.scrollBarEventProc);
            }
         }
         return this.var_376;
      }
      ...
      {
         if(param1.type == WindowEvent.const_285)
         {
            this.showScrollBar();
         }
         else if(param1.type == WindowEvent.const_205)
         {
            this.hideScrollBar();
         }
      }

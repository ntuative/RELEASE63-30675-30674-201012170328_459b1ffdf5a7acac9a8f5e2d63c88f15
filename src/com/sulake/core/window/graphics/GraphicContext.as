package com.sulake.core.window.graphics
{
   ...
   public class GraphicContext extends Sprite implements IGraphicContext
   {
      ...
      public static const const_1636:uint = 64;
      
      public static const const_1723:uint = 128;
      
      public static const GC_TYPE_DESKTOP:uint = 256;
      
      protected static var var_515:uint = 0;
      
      protected static var var_290:uint = 0;
       
      
      protected var _childSpriteContainer:DisplayObjectContainer;
      
      protected var var_1884:Boolean;
      
      protected var var_759:Boolean;
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._childSpriteContainer != null)
            {
               while(this._childSpriteContainer.numChildren > 0)
               {
                  this._childSpriteContainer.removeChildAt(0);
               }
            }
            this._childSpriteContainer = null;
            while(numChildren > 0)
            {
               removeChildAt(0);
            }
         ...
         if(this.var_759)
         {
            ...
            if(displayObject is Bitmap)
            {
               ...
               if(bitmap != null)
               {
                  ...
                  {
                     var_290 -= bitmap.width * bitmap.height * 4;
                     bitmap.dispose();
                     bitmap = null;
                  }
               }
               if(bitmap == null && width > 0 && height > 0)
               {
                  try
                  {
                     bitmap = new TrackedBitmapData(this,width,height,this.var_1884,16777215);
                  }
                  catch(e:Error)
                  {
                     bitmap = new TrackedBitmapData(this,1,1,var_1884,16777215);
                  }
                  var_290 += bitmap.width * bitmap.height * 4;
               }
      ...
      protected function releaseDrawBuffer() : void
      {
         ...
         if(this.var_759)
         {
            ...
            if(_loc1_ is Bitmap)
            {
               ...
               if(_loc2_ != null)
               {
                  var_290 -= _loc2_.width * _loc2_.height * 4;
                  _loc2_.dispose();
               }
            }
         }
      ...
      protected function setupChildContainer() : DisplayObjectContainer
      {
         if(this._childSpriteContainer == null)
         {
            this._childSpriteContainer = new Sprite();
            this._childSpriteContainer.name = this.name + " - Child Container";
            this._childSpriteContainer.mouseEnabled = false;
            addChild(this._childSpriteContainer);
         }
         return this._childSpriteContainer;
      }
      ...
      protected function removeChildContainer() : void
      {
         if(this._childSpriteContainer != null)
         {
            removeChild(this._childSpriteContainer);
            this._childSpriteContainer = null;
         }
      }
      ...
      {
         return this._childSpriteContainer != null ? int(this._childSpriteContainer.numChildren) : 0;
      }

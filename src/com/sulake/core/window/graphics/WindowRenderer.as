package com.sulake.core.window.graphics
{
   ...
   public class WindowRenderer implements IWindowRenderer
   {
      ...
      private var var_1814:Point;
      
      private var var_1386:Rectangle;
      
      private var var_282:Rectangle;
      ...
      public function WindowRenderer(param1:ISkinContainer)
      {
         ...
         this.var_732 = new Array();
         this.var_1814 = new Point();
         this.var_1386 = new Rectangle();
         this.var_282 = new Rectangle();
         this.var_339 = new Dictionary(true);
         this.var_781 = param1;
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            this._disposed = true;
            this.var_732 = null;
            for(_loc1_ in this.var_339)
            {
               delete this.var_339[_loc1_];
            }
            this.var_339 = null;
      ...
      public function addToRenderQueue(param1:IWindow, param2:Rectangle, param3:uint) : void
      {
         ...
         if(this.getWindowRendererItem(param1).invalidate(param1,param2,param3))
         {
            ...
            this.var_282.x = param2.x - param1.x;
            this.var_282.y = param2.y - param1.y;
            this.var_282.width = param2.width;
            this.var_282.height = param2.height;
            if(param1.testParamFlag(WindowParam.const_31))
            {
               while(param1.testParamFlag(WindowParam.const_31))
               {
                  ...
                  this.var_282.offset(param1.x,param1.y);
                  param1 = _loc4_;
               }
            }
            this.getWindowRendererItem(param1).invalidate(param1,this.var_282,WindowRedrawFlag.const_922);
            if(this.var_732.indexOf(param1) == -1)
            {
      ...
      public function invalidate(param1:IWindowContext, param2:Rectangle) : void
      {
         ...
         while(_loc4_-- > 0)
         {
            ...
            this.addToRenderQueue(_loc5_,_loc5_.rectangle,WindowRedrawFlag.const_74);
         }
      }
      
      protected function getWindowRendererItem(param1:IWindow) : WindowRendererItem
      {
         var _loc2_:WindowRendererItem = this.var_339[param1] as WindowRendererItem;
         if(_loc2_ == null)
         {
            this.registerRenderable(param1);
            _loc2_ = this.var_339[param1];
         }
         return _loc2_;
      }
      ...
      public function registerRenderable(param1:IWindow) : void
      {
         ...
         if(_loc2_ == null)
         {
            _loc2_ = new WindowRendererItem(this,this._drawBufferAllocator,this.var_781);
            this.var_339[param1] = _loc2_;
            param1.addEventListener(WindowDisposeEvent.const_632,this.windowDisposedCallback);
         }
      }
      
      public function removeRenderable(param1:IWindow) : void
      {
         param1.removeEventListener(WindowDisposeEvent.const_632,this.windowDisposedCallback);
         var _loc2_:WindowRendererItem = this.var_339[param1] as WindowRendererItem;
         if(_loc2_ != null)
         {
            _loc2_.dispose();
            delete this.var_339[param1];
         }
      }
      ...
      public function render() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         var _loc2_:uint = this.var_732.length;
         _loc4_ = 0;
         while(_loc4_ < _loc2_)
         {
            _loc1_ = this.var_732.pop() as WindowController;
            if(!_loc1_.disposed)
            {
               _loc3_ = this.getWindowRendererItem(_loc1_);
               this.var_282.x = _loc3_.dirty.x;
               this.var_282.y = _loc3_.dirty.y;
               this.var_282.width = _loc3_.dirty.width;
               this.var_282.height = _loc3_.dirty.height;
               this.renderWindowBranch(_loc1_,this.var_282,_loc1_.rectangle.clone());
            }
            _loc4_++;
         }
      }
      ...
      private function renderWindowBranch(param1:WindowController, param2:Rectangle, param3:Rectangle) : void
      {
         ...
         if(param1.visible)
         {
            if(getDrawLocationAndClipRegion(param1,param2,this.var_1814,this.var_1386))
            {
               if(this.getWindowRendererItem(param1).render(param1,this.var_1814,this.var_1386))
               {
            ...
            else if(!param1.testParamFlag(WindowParam.const_31))
            {
               ...
               {
                  param1.getGraphicContext(true).setDrawRegion(param1.rectangle,false,this.var_1386);

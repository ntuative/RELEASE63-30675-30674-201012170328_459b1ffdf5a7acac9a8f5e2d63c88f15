package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1524:uint = 1;
      
      protected static const const_1523:uint = 2;
      
      protected static const const_1525:uint = 4;
      
      protected static const const_1522:uint = 3;
      
      protected static const name_2:uint = 7;
      
      public static const const_1485:int = 5;
      
      public static const LIBRARY_LOADER_FINALIZE:String = "LIBRARY_LOADER_FINALIZE";
      
      public static const const_971:Boolean = false;
      
      public static const const_1405:int = 2;
      
      private static var var_808:Array = new Array();
      
      private static var var_658:Array = new Array();
      ...
      protected var var_214:URLRequest;
      
      protected var var_694:XML;
      
      protected var var_585:Class;
      
      protected var var_412:uint = 0;
      
      protected var _name:String;
      
      protected var var_934:Boolean = false;
      ...
      protected var var_2626:String = "";
      
      protected var var_1888:int;
      
      protected var var_1160:int;
      
      protected var var_1161:int;
      
      protected var var_2710:uint = 0;
      
      protected var var_2627:Boolean = true;
      ...
      protected static function queue(param1:LibraryLoader) : void
      {
         ...
         {
            param1.var_36.load(param1.var_214,param1.var_16);
         }
      }
      ...
      protected static function throttle() : void
      {
         ...
         if(const_971)
         {
            ...
            while(_loc2_ > -1)
            {
               _loc1_ = var_658[_loc2_] as LibraryLoader;
               if(_loc1_ && (_loc1_.ready || _loc1_.disposed))
               {
                  var_658.splice(_loc2_,1);
               }
               _loc2_--;
            }
            while(var_658.length < const_1405 && false)
            {
               _loc1_ = var_808.shift() as LibraryLoader;
               if(!_loc1_.ready && !_loc1_.disposed)
               {
                  var_658.push(_loc1_);
                  _loc1_.var_36.load(_loc1_.var_214,_loc1_.var_16);
               }
            }
         }
      }
      ...
      {
         return !!this.var_214 ? this.var_214.url : null;
      }
      ...
      {
         return !!this.var_934 ? uint(this.var_1160 - this.var_1888) : uint(getTimer() - this.var_1888);
      }
      ...
      public function load(param1:URLRequest, param2:int = 5) : void
      {
         ...
         this._name = parseNameFromUrl(this.var_214.url);
      ...
      {
         if(this.var_933 && !_disposed)
         {
            this.var_933 = false;
            if(!this.var_934 && this.var_214)
            {
               this.var_1160 = -1;
      ...
      {
         if(!this.var_934 && !_disposed && this.var_1161 > 0)
         {
            try
            {
               this.var_36.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_214,const_1485 - this.var_1161);
            if(this.var_2627)
            {
               this.var_214.requestHeaders.push(new URLRequestHeader("pragma","no-cache"));
               this.var_214.requestHeaders.push(new URLRequestHeader("Cache-Control","no-cache"));
               this.var_2627 = false;
            }
            --this.var_1161;
            this.var_412 = 0;
            this.var_36.load(this.var_214,this.var_16);
            return true;
         }
         return false;
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(this.var_412 == LibraryLoader.const_1522)
         {
      ...
      protected function prepareLibrary() : Boolean
      {
         ...
         this.var_585 = this.getDefinition(this._name) as Class;
         if(this.var_585 == null)
         {
            if(!this.retry())
            {
               this.failure("Failed to find resource class \"" + this._name + "\" from library " + this.var_214.url + "!");
            }
            return false;
         }
         try
         {
            xmlClass = this.var_585.manifest as Class;
            if(xmlClass == null)
            {
               return false;
            }
         ...
         try
         {
            this.var_694 = new XML(bytes.readUTFBytes(bytes.length));
         }
         catch(e:Error)
         {
            if(!retry())

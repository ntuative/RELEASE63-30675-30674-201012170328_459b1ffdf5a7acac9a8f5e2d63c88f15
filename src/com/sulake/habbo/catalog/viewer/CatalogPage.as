package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      protected static const const_1528:String = "ctlg_";
       
      
      protected var var_1897:XML;
      
      protected var _window:IWindowContainer;
      
      private var var_1065:ICatalogViewer;
      ...
      private var var_1324:EventDispatcher;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_1324 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1072);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1072);
      }
      ...
      {
         var _loc2_:String = const_1528 + param1;
         ...
         this.var_1897 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_1897) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidgets() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_1323 = new ItemGridCatalogWidget(_loc1_);
            this.var_57.push(this.var_1323);
         }
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1274) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1265) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1513) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1332) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_57.push(new BotCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1497) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_57.push(new TextInputCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1476) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_57.push(new SpecialInfoWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1441) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1255) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_57.push(new ClubGiftWidget(_loc1_,this._catalog.getClubGiftController()));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1472) as IWindowContainer;
         if(_loc1_ != null)
         {
            this.var_57.push(new ClubBuyCatalogWidget(_loc1_));
         }
         _loc1_ = this._window.findChildByName(CatalogWidgetEnum.const_1262) as IWindowContainer;
         if(_loc1_ != null)
         {
         ...
         {
            _loc2_.page = this;
            _loc2_.events = this.var_1324;
            _loc2_.init();
         }
         this.var_1324.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         return this.var_1324.dispatchEvent(param1);
      }
   }
}

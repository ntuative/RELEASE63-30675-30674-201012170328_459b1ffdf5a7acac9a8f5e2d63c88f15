package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_1689:Point;
      
      private var var_462:IItemGridWindow;
      
      private var var_1308:IScrollbarWindow;
      ...
      {
         this.var_841 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         this.var_1066 = _window.findChildByName("ctlg_description") as ITextWindow;
         this.var_82 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         this.var_1689 = new Point(this.var_82.x,this.var_82.y);
         this.var_462 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1308 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
         ...
         this.var_1690 = _loc2_.content as BitmapData;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(this.var_462 != null)
         {
            this.var_462.visible = false;
            this.var_462.destroyGridItems();
         }
         if(this.var_1308 != null)
         {
            this.var_1308.visible = false;
         }
         ...
         this.var_841.text = _loc4_;
         this.var_1066.text = _loc5_;
         this.var_841.height = this.var_841.textHeight + 5;
         this.var_1066.y = this.var_841.y + this.var_841.height;
         this.var_1066.height = Math.max(130,this.var_1066.textHeight + 5);
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_500:
                  _loc6_ = this.var_1690.clone();
                  if(this.var_462 != null)
                  {
                     this.var_462.visible = true;
                     _loc10_ = _loc2_.productContainer as BundleProductContainer;
                     _loc10_.populateItemGrid(this.var_462,this.var_1308,this.var_1687);
                     this.var_462.scrollV = 0;
                  }
                  break;
               case Offer.const_466:
               case Offer.const_519:
                  ...
                  switch(_loc8_.productType)
                  {
                     ...
                     case ProductTypeEnum.const_215:
                        ...
                        _loc6_ = new BitmapData(this.var_82.width,this.var_82.height,false,_loc13_);
                        _loc14_ = null;
                        ...
                        if(_loc15_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc16_ != null)
                           {
                              ...
                              _loc16_.appendAction(AvatarAction.const_309,AvatarAction.const_397);
                              _loc16_.appendAction(AvatarAction.const_287,_loc8_.productClassId);
                              ...
                              if(_loc14_ != null)
                              {
                                 ...
                                 for each(_loc21_ in _loc16_.method_1())
                                 {
      ...
      private function addEffectSprites(param1:BitmapData, param2:IAvatarImage, param3:Point, param4:Point, param5:Boolean = true) : void
      {
         ...
         var _loc20_:* = null;
         for each(_loc6_ in param2.method_1())
         {
            _loc7_ = _window.getChildIndex(this.var_82);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2344)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2344 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_82 != null && true)
         {
            ...
            _loc4_ = new Point((this.var_82.width - param1.width) / 2,(this.var_82.height - param1.height) / 2);
            this.var_82.bitmap.copyPixels(param1,param1.rect,_loc4_,null,null,true);
            this.var_82.invalidate();
            this.var_82.x = this.var_1689.x;
            this.var_82.y = this.var_1689.y;
            if(param3 != null)
            {
               this.var_82.x += param3.x;
               this.var_82.y += param3.y;
            }
         }
         if(param2)
         {

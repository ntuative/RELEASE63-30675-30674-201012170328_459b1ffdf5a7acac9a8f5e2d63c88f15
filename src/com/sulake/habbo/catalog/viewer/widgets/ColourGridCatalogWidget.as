package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function populateColourGrid() : void
      {
         ...
         var _loc13_:* = null;
         var _loc14_:* = 0;
         Logger.log("[ColourGridCatalogWidget] Display colors: " + [this.var_1328.length,this._colourGrid.numGridItems]);
         this._colourGrid.destroyGridItems();
         this.var_321 = null;
         for each(_loc1_ in this.var_1328)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(this.var_693.width,this.var_693.height,true,0);
               _loc3_.bitmap.copyPixels(this.var_693,this.var_693.rect,new Point(0,0));
            }
            _loc4_ = _loc2_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(this.var_1144.width,this.var_1144.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
            ...
            if(_loc5_ != null)
            {
               _loc5_.bitmap = new BitmapData(this.var_924.width,this.var_924.height,true,16777215);
               _loc5_.bitmap.copyPixels(this.var_924,this.var_924.rect,new Point(0,0),null,null,true);

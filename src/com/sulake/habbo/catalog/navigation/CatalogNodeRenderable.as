package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1183:Number = 4285716709;
      
      private static var _listSubItemWindowLayout:XML;
      
      private static var var_1312:XML;
      
      private static var var_1313:XML;
       
      
      private var var_1694:Number = 4.294967295E9;
      
      private var _icon:BitmapData;
      
      private var _window:IWindowContainer;
      
      private var var_2657:IWindowContainer;
      ...
      public function CatalogNodeRenderable(param1:ICatalogNavigator, param2:NodeData, param3:int)
      {
         ...
         if(var_1312 == null)
         {
            ...
            var_1312 = _loc4_.content as XML;
         }
         if(var_1313 == null)
         {
      ...
      public function addToList(param1:IItemListWindow) : void
      {
         ...
         if(isBranch)
         {
            ...
            param1.addListItem(this.var_54);
         }
      }
      ...
      public function removeFromList(param1:IItemListWindow) : void
      {
         ...
         if(isBranch)
         {
            param1.removeListItem(this.var_54);
         }
      }
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1694 == 4294967295)
            {
               this.var_1694 = _loc1_.color;
            }
            _loc1_.color = const_1183;
         }
      }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1415;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_1399;
            }
         }
      }
      ...
      private function showChildren() : void
      {
         ...
         for each(_loc1_ in children)
         {
            ...
            {
               (_loc1_ as CatalogNodeRenderable).addToList(this.var_54);
            }
         }
         if(this.var_54 != null)
         {
            this.var_54.visible = true;
            this.var_54.height = this.var_54.numListItems * 21;
         }
      }
      ...
      private function removeChildren() : void
      {
         ...
         for each(_loc1_ in children)
         {
            if(_loc1_.isNavigateable)
            {
               (_loc1_ as CatalogNodeRenderable).removeFromList(this.var_54);
            }
         }
         if(this.var_54 != null)
         {
            this.var_54.height = 0;
      ...
      {
         this.var_54 = navigator.catalog.windowManager.buildFromXML(var_1313) as IItemListWindow;
         if(this.var_54 == null)
         {
      ...
      private function createWindow() : void
      {
         if(depth == 1)
         {
            this._window = navigator.catalog.windowManager.buildFromXML(var_1312) as IWindowContainer;
         }
         else
         {

package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener
   {
      ...
      private var var_86:IPurchasableOffer;
      ...
      private const const_1848:int = 10;
      ...
      private const const_1558:uint = 4.293848814E9;
      
      private const const_1559:uint = 4.294967295E9;
      
      private const const_1849:uint = 4.291613146E9;
      ...
      {
         if(this.var_86 == null || this.var_86.offerId != param1.offerId)
         {
            return;
         }
      ...
      private function showConfirmationDialog() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc3_ = this._catalog.getProductData(this.var_86.localizationId);
         ...
         if(_loc2_ != null)
         {
            _loc4_ = this.var_86.page.viewer.roomEngine;
            _loc7_ = 0;
            _loc8_ = "";
            _loc9_ = "";
            if(this.var_86 is Offer)
            {
               _loc10_ = this.var_86.productContainer.firstProduct;
               _loc9_ = _loc10_.productType;
               _loc7_ = _loc10_.productClassId;
               _loc8_ = _loc10_.extraParam;
            }
            else if(this.var_86 is ClubBuyOfferData)
            {
               _loc9_ = "null";
            }
            switch(_loc9_)
      ...
      {
         var _loc1_:IProductData = this._catalog.getProductData(this.var_86.localizationId);
         ...
         var _loc3_:BalanceAndCost = new BalanceAndCost(this._catalog,this._localization,this.var_86);
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            this.var_1758 = _loc1_.stuffTypes;
            this.var_749 = _loc1_.boxTypes;
            this.var_748 = _loc1_.ribbonTypes;
            this.var_1146 = this.var_1758[0];
            this.var_345 = this.var_749[0];
            this.var_344 = this.var_748[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         ...
         if(this.var_344 < 0)
         {
            this.var_344 = this.var_748.length - 1;
         }
         if(this.var_344 > this.var_748.length - 1)
         {
            this.var_344 = 0;
         }
         if(this.var_345 < 0)
         {
            this.var_345 = this.var_749.length - 1;
         }
         if(this.var_345 > this.var_749.length - 1)
         {
            this.var_345 = 0;
         }
         var _loc1_:int = this.var_749[this.var_345] * 1000 + this.var_748[this.var_344];
         if(this._window == null)
         {
            return;
         }
         var _loc2_:IRoomEngine = this.var_86.page.viewer.roomEngine;
         _loc3_ = _loc2_.getFurnitureImage(this.var_1146,new Vector3d(180),64,this,_loc1_.toString());
         if(_loc3_ == null)
         {
            return;
         }
         this.var_1415 = _loc3_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         var _loc3_:Array = this.var_1758;
         for each(_loc6_ in _loc3_)
         {
            _loc4_ = this._catalog.getFurnitureData(_loc6_,ProductTypeEnum.const_82);
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1146);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_749[this.var_345]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_748[this.var_344]);
         this._catalog.purchaseProductAsGift(this._pageId,this.var_86,this.var_1414,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      ...
      private function confirmationHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "gift_button":
               ...
               break;
            case "buy_button":
               this._catalog.purchaseProduct(this._pageId,this.var_86.offerId,this.var_1414);
               this.dispose();
               break;
            case "cancel_button":
      ...
      private function nameInputHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            case WindowEvent.const_113:
               _loc3_ = param1.window as ITextFieldWindow;
               if(_loc3_ == null)
               {
                  return;
               }
               if(this.var_2601 == _loc3_.text)
               {
                  return;
               }
               ...
               for each(_loc7_ in this.var_212)
               {
                  ...
                  if(_loc5_.length >= this.const_1848)
                  {
                     break;
                  }
               }
               this.updateSuggestions(_loc5_);
               this.var_2601 = _loc3_.text;
               break;
            case WindowMouseEvent.const_38:
               ...
               break;
            case WindowKeyboardEvent.const_698:
               _loc6_ = param1 as WindowKeyboardEvent;
               switch(_loc6_.keyCode)
               {
                  case Keyboard.UP:
                     this.highlightSuggestion(this.var_346 - 1);
                     break;
                  case Keyboard.DOWN:
                     this.highlightSuggestion(this.var_346 + 1);
                     break;
      ...
      {
         if(this.var_249 == null || !this.var_249.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_249.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_346) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_249 == null)
         {
            this.var_249 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_615 == null)
         {
            this.var_615 = this.createWindow("suggestion_list_item") as IWindowContainer;
            this.var_615.procedure = this.suggestionsEventHandler;
         }
         if(this.var_249 == null || this.var_615 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_249.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_615.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_346) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_346);
         }
         this.var_346 = param1;
         if(this.var_346 < 0)
         {
            this.var_346 = _loc2_.numListItems - 1;
         }
         if(this.var_346 >= _loc2_.numListItems)
         {
            this.var_346 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_346) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1849;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_1558) : uint(this.const_1559);
      }
      ...
      private function suggestionsEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER:
               _loc5_ = this.var_249.findChildByName("suggestion_list") as IItemListWindow;
               if(_loc5_ == null)
               {
                  return;
               }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1146;
               }
            }
            _loc4_++;
         }

package com.sulake.habbo.roomevents.userdefinedroomevents.common
{
   ...
   public class SliderWindowController extends EventDispatcher
   {
      ...
      private var var_988:Number = 1.0;
      ...
      public function setValue(param1:Number, param2:Boolean = true) : void
      {
         ...
         param1 = Math.min(this.var_988,param1);
         this.var_797 = param1;
         if(param2)
         {
      ...
      private function updateSliderPosition() : void
      {
         ...
         if(_loc1_ != null)
         {
            _loc1_.x = this.getSliderPosition(this.var_797);
         }
      ...
      {
         return int(this.var_1506 * (Number(param1 - this._minValue) / (this.var_988 - this._minValue)));
      }
      
      private function getValueAtPosition(param1:Number) : Number
      {
         return param1 / this.var_1506 * (this.var_988 - this._minValue) + this._minValue;
      }
      ...
      private function sliderProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_798)
         {
            if(param1.type == WindowMouseEvent.const_54 || param1.type == WindowMouseEvent.const_176)
            {
               this.var_798 = false;
            }
         }
         if(!this.var_798 || param1.type != WindowEvent.const_349)
         {
            return;
         }
         if(this.var_540 != 0)
         {
            ...
            _loc4_ = Math.round(_loc3_ / this.var_540) * this.var_540;
      ...
      private function sliderButtonRightProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            if(this.var_540 != 0)
            {
               _loc3_ = this.var_797 + this.var_540;
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc2_ != null && this.var_652 != null)
         {
            _loc2_.bitmap = new BitmapData(this.var_652.width,this.var_652.height,true,16777215);
            _loc2_.bitmap.copyPixels(this.var_652,this.var_652.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null && this.var_653 != null)
            {
               ...
               this.var_1506 = _loc1_.width - _loc2_.width;
            }
         }
      ...
      private function storeAssets(param1:IAssetLibrary) : void
      {
         ...
         this.var_652 = BitmapData(_loc2_.content);

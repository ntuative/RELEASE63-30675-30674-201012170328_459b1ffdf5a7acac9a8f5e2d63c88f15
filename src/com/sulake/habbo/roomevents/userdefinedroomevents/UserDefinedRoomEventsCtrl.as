package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private var var_1755:TriggerConfs;
      
      private var var_1753:ActionTypes;
      
      private var var_1754:ConditionTypes;
      
      private var var_241:Dictionary;
      
      private var var_58:Triggerable;
      
      private var var_708:RoomObjectHightLighter;
      
      private var var_171:UserDefinedRoomEventsHelp;
      
      private var var_1089:SliderWindowController;
      
      public function UserDefinedRoomEventsCtrl(param1:HabboUserDefinedRoomEvents)
      {
         this.var_1755 = new TriggerConfs();
         this.var_1753 = new ActionTypes();
         this.var_1754 = new ConditionTypes();
         this.var_241 = new Dictionary();
         super();
         this.var_89 = param1;
         this.var_708 = new RoomObjectHightLighter(param1);
         this.var_171 = new UserDefinedRoomEventsHelp(param1);
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1089 = new SliderWindowController(this.var_89,IWindowContainer(this.find(this.var_88,"delay_slider_container")),this.var_89.assets,0,20,1);
         this.var_1089.addEventListener(Event.CHANGE,this.onDelaySliderChange);
         this.var_1089.setValue(0);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_708.hideAll(this.var_241);
         }
      }
      ...
      public function prepareForUpdate(param1:Triggerable) : void
      {
         ...
         this.var_708.showAll(this.var_241);
         if(this.var_58 as ActionDefinition != null)
         {
            _loc5_ = ActionDefinition(this.var_58);
            _loc6_ = _loc5_.delayInPulses;
            this.var_1089.setValue(_loc6_);
         }
         this.refresh();
      }
      ...
      public function getActionDelay() : int
      {
         ...
         return !!_loc1_.allowDelaying ? int(this.var_1089.getValue()) : 0;
      }
      ...
      private function onHelp(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_171.open(this._window.x + this._window.width + 5,this._window.y);
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_1753);

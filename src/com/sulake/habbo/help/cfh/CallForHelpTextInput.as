package com.sulake.habbo.help.cfh
{
   ...
   public class CallForHelpTextInput extends HelpViewController implements IHelpViewController
   {
      ...
      private static const const_1158:int = 30;
      
      private static const const_1157:int = 253;
      
      private static const const_1159:int = 10;
      ...
      {
         main.showUI(HabboHelpViewEnum.const_173);
      }
      ...
      private function sendCallForHelp() : void
      {
         ...
         if(inputField.text.length < const_1158)
         {

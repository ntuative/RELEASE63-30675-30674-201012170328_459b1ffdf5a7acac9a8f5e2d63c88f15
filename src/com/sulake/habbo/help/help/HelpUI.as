package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private static const const_1534:int = 0;
      ...
      {
         this.var_297 = this._defaultViewId;
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201012170237));
         this._toolbar = param5;
         this.var_92 = new Map();
         this.var_92.add(HabboHelpViewEnum.const_1392,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_173,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_536,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_265,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_245,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_786,IHelpViewController(new FaqBrowseSearchResults(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_324,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_579,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_216,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_92.add(HabboHelpViewEnum.const_1069,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_92.add(HabboHelpViewEnum.const_1106,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_92.add(HabboHelpViewEnum.const_812,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function dispose() : void
      {
         ...
         var _loc1_:Array = this.var_92.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = this.var_92.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         {
            if(this.var_420.length == 0 || param1 != this.var_297)
            {
               this.var_420.push(this.var_297);
            }
         }
         this.var_297 = param1;
         ...
         if(_loc4_ == null)
         {
            Logger.log("* No view controller found for " + this.var_297);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_216:
               this.showUI(HabboHelpViewEnum.const_216);
               break;
            case CallForHelpResultEnum.const_987:
               this.showUI(HabboHelpViewEnum.const_1106);
               break;
            case CallForHelpResultEnum.const_1012:
               this.showUI(HabboHelpViewEnum.const_1069);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_92.getValue(HabboHelpViewEnum.const_173) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this._component.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_423));
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         var _loc3_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_92.length)
         {
            _loc3_ = this.var_92.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      {
         return this.var_92.getValue(this.var_297);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_1436 = this._window.width - _loc4_.width;
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_1437;
         this._window.width = _loc1_.width + this.var_1436;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_420.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_297 == HabboHelpViewEnum.const_173)
         {
            return;
         }
         if(this.var_522.length < 2)
         {
            _loc3_ = this._assetLibrary.getAssetByName("back_png") as BitmapDataAsset;
            this.var_522.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_522.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_296.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_522[1],this.var_522[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_522[0],this.var_522[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         if(this.var_297 == HabboHelpViewEnum.const_173 || this.var_420.length == 0)
         {
            return;
         }
         if(this.var_296 == null)
         {
            ...
            this.var_296 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
            _loc4_ = this.var_296.findChildByName("back_image");
            if(_loc4_ != null)
            {
            ...
            _loc5_ = this.var_296.findChildByName("back_text");
            if(_loc5_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_296 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_296 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_296 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}

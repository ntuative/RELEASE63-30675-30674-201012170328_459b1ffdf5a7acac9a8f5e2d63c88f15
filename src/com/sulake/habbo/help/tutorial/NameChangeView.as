package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_675)
         {
            this.var_675 = this._controller.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_675)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_674)
         {
            this.var_674 = this._controller.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_674)
            {
               return;
            }

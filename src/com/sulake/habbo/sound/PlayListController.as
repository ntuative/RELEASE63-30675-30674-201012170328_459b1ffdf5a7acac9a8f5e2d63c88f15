package com.sulake.habbo.sound
{
   ...
   public class PlayListController implements IDisposable
   {
      ...
      private const const_1846:String = "type_sound_machine";
      
      private const const_1570:String = "type_jukebox";
      ...
      public function PlayListController(param1:HabboSoundManagerFlash10, param2:IEventDispatcher, param3:IEventDispatcher, param4:IConnection)
      {
         ...
         this._events.addEventListener(SoundCompleteEvent.const_765,this.onSongFinishedPlayingEvent);
         this.var_89.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_605,this.onSoundMachinePlayEvent);
         this.var_89.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_792,this.onSoundMachineStopEvent);
         this.var_89.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_724,this.onJukeboxInitEvent);
         this.var_89.addEventListener(RoomObjectSoundMachineStateUpdateEvent.const_403,this.onDisposeEvent);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._events)
            {
               this._events.removeEventListener(SoundCompleteEvent.const_765,this.onSongFinishedPlayingEvent);
               this._events = null;
            }
            if(this.var_89)
            {
               this.var_89.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_605,this.onSoundMachinePlayEvent);
               this.var_89.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_792,this.onSoundMachineStopEvent);
               this.var_89.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_724,this.onJukeboxInitEvent);
               this.var_89.removeEventListener(RoomObjectSoundMachineStateUpdateEvent.const_403,this.onDisposeEvent);
               this.var_89 = null;
            }
            if(this.var_401)
            {
      ...
      {
         this.startPlaying(this.const_1846);
      }
      ...
      {
         this.startPlaying(this.const_1570);
      }
      ...
      public function startPlaying(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_281 = _loc2_.id;
            this.playSong(this.var_281);
         }
      }
      
      public function checkSongPlayState(param1:int) : void
      {
         if(this.var_281 == param1)
         {
            this.playSong(this.var_281);
         }
      }
      ...
      {
         var _loc1_:IHabboSound = this.var_401[this.var_281] as IHabboSound;
         if(_loc1_ != null)
         {
            _loc1_.stop();
         }
      ...
      {
         var _loc2_:IHabboSound = this.var_401.getValue(this.var_281) as IHabboSound;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function playSong(param1:int) : void
      {
         var _loc6_:* = null;
         this.var_281 = param1;
         var _loc2_:IHabboSound = this.var_401.getValue(param1) as IHabboSound;
         if(_loc2_ == null)
         {
         ...
         if(_loc5_ != null && _loc5_.id != this.var_281)
         {
            _loc6_ = this.var_401[_loc5_.id] as IHabboSound;
            if(_loc6_ == null)
            {
      ...
      {
         if(this.var_1785 == this.const_1570)
         {
            this.var_74.shift();
         }
         var _loc2_:PlayListEntry = this.getNextEntry();
      ...
      private function requestSongInfo(param1:int) : void
      {
         ...
         if(this.var_600.indexOf(param1) == -1)
         {
            this.var_600.push(param1);
         }
      }
      ...
      private function onSongInfoMessage(param1:IMessageEvent) : void
      {
         ...
         this.var_600 = this.var_600.splice(this.var_600.indexOf(_loc3_.id),1);
         if(_loc4_)
         {
            _loc7_ = this.var_401[_loc3_.id] as IHabboSound;
            if(_loc7_ == null)
            {
               _loc7_ = this.var_550.loadTraxSong(_loc3_.id,_loc3_.data);
               this.var_401.add(_loc3_.id,_loc7_);
            }

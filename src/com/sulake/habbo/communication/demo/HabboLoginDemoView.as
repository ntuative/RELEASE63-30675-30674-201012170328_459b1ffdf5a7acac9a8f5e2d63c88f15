package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_424:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_146.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_132,HabboWindowStyle.const_37,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         var _loc7_:SharedObject = SharedObject.getLocal(this.const_1557,"/");
         if(_loc5_ != null)
         {
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            _loc6_ = SharedObject.getLocal(this.const_1557,"/");
         ...
         {
            dispatchEvent(new Event(const_424));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_126.removeEventListener(SSOTicket.const_333,this.onParsedTicketSuccess);
            this.var_126.removeEventListener(SSOTicket.const_299,this.onParsedTicketFailure);
            this.var_126 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_126 = new SSOTicket(this.var_146.assets,_loc3_,_loc2_,param1);
         this.var_126.addEventListener(SSOTicket.const_333,this.onParsedTicketSuccess);
         this.var_126.addEventListener(SSOTicket.const_299,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_146.shockwaveClientUrl = this.var_126.shockwaveClientUrl;
         this.var_146.ssoTicket = this.var_126.ticket;
         this.var_126.removeEventListener(SSOTicket.const_333,this.onParsedTicketSuccess);
         this.var_126.removeEventListener(SSOTicket.const_299,this.onParsedTicketFailure);
         this.var_126 = null;
         dispatchEvent(new Event(const_424));

package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_459:IKeyExchange;
      
      private var var_834:String;
      
      private var _view:HabboLoginDemoView;
      
      private var var_2281:PseudoRandom;
      ...
      private var var_202:HabboHotelView;
      
      private var var_1294:String = "";
      
      private const const_1557:String = "fuselogin";
      ...
      {
         if(param1 && !this.var_573)
         {
            this.var_573 = param1;
            this.var_46.initConnection(HabboConnectionType.const_250);
         }
      }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_18.events.addEventListener(RoomSessionEvent.const_94,this.onRoomSessionEnded);
         this.checkRequirements();
      }
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_202 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         ...
         {
            this.var_202.loadHotelViewImage(_loc2_ + _loc1_);
         }
         var _loc3_:* = this._habboConfiguration.getKey("use.sso.ticket") == "1";
         this.var_573 = this._habboConfiguration.getKey("sso.ticket",null);
         this.var_1658 = this._habboConfiguration.getKey("flash.client.url","");
         this.var_2282 = this._habboConfiguration.getKey("external.variables.txt","");
         if(this.var_202 == null)
         {
            this.var_202 = new HabboHotelView(this._windowManager,assets,Component(context).events);
         }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc4_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_424,this.onInitConnection);
            }
         }
      }
      ...
      private function onInitConnection(param1:Event = null) : void
      {
         ...
         else
         {
            ...
            {
               this.var_46.mode = HabboConnectionType.const_1075;
            }
         }
         this.var_46.initConnection(HabboConnectionType.const_250);
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_762);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2281 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_46.mode)
         {
            case HabboConnectionType.const_114:
               ...
               this.var_1294 = _loc4_;
               this.var_202.loadBannerImage(_loc7_ + "?token=" + this.var_1294,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1075:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1331:
               this.var_834 = this.generateRandomHexString(30);
               this.var_459 = new DiffieHellman(new BigInteger(this._habboConfiguration.getKey("connection.development.prime"),16),new BigInteger(this._habboConfiguration.getKey("connection.development.generator"),16));
               this.var_459.init(this.var_834);
               _loc8_ = this.var_459.getPublicKey(10);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_459.generateSharedKey(_loc4_,10);
         var _loc5_:String = this.var_459.getSharedKey(16).toUpperCase();
         var _loc6_:RC4_R27 = new RC4_R27(null,null);
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2281);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1658,this.var_2282));
         var machineId:String = "";
         try
         {
            so = SharedObject.getLocal(this.const_1557,"/");
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_573 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(this.var_573);
            _loc2_.send(_loc4_);
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_170);
         }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_244);
      }
      ...
      private function onStartRegistration(param1:IMessageEvent) : void
      {
         ...
         this.dispatchLoginStepEvent(HabboCommunicationEvent.const_248);
      }
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(this.var_1295)
         {
            this.dispatchLoginStepEvent(HabboCommunicationEvent.const_171);
         }
      ...
      private function onDisconnectReason(param1:DisconnectReasonEvent) : void
      {
         ...
         if(_loc2_.length > 0)
         {
            _loc2_ = this.method_8(_loc2_,param1.reasonString);
            _loc2_ = this.setOriginProperty(_loc2_);
      ...
      private function method_8(param1:String, param2:String) : String
      {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1294);
         ...
         this.var_459 = new DiffieHellman(_loc10_,_loc11_);
         var _loc13_:int = 10;
         var _loc14_:* = null;
         while(_loc13_ > 0)
         {
            _loc14_ = this.generateRandomHexString(30);
            this.var_459.init(_loc14_);
            _loc15_ = this.var_459.getPublicKey(10);
            if(_loc15_.length >= 64)
            {
               _loc12_ = _loc15_;
               this.var_834 = _loc14_;
            }

package com.sulake.habbo.navigator.mainview.tabpagedecorators
{
   ...
   public class MyRoomsTabPageDecorator implements ITabPageDecorator
   {
      ...
      private var var_2698:IWindowContainer;
      ...
      public function refreshCustomContent(param1:IWindowContainer) : void
      {
         ...
         {
            this.var_467 = IDropMenuWindow(_loc3_.findChildByName("meSubNavi"));
            this.var_467.procedure = this.onChangeSubNavi;
            this.prepareSubNavi();
         }
         _loc3_.visible = true;
      }
      ...
      {
         var _loc1_:int = this.var_467 == null ? 0 : int(this.var_467.selection);
         Logger.log("Me subNavi selection changed: " + _loc1_);
         this._navigator.mainViewCtrl.startSearch(Tabs.const_304,this.getSearchTypeForIndex(_loc1_));
      }
      ...
      private function getSearchTypeForIndex(param1:int) : int
      {
         if(param1 == 1)
         {
            return Tabs.const_685;
         }
         if(param1 == 2)
         {
            return Tabs.const_684;
         }
         if(param1 == 3)
         {
            return Tabs.const_690;
         }
         if(param1 == 4)
         {
            return Tabs.const_759;
         }
         return Tabs.const_212;
      }
   }
}

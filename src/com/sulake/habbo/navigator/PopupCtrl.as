package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function dispose() : void
      {
         ...
         if(this.var_305)
         {
            this.var_305.removeEventListener(TimerEvent.TIMER,this.onHideTimer);
            this.var_305.reset();
            this.var_305 = null;
         }
      }
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_48 == null)
         {
            this.var_48 = IWindowContainer(this._navigator.getXmlWindow(this.var_1191));
            this.var_48.visible = false;
            this.var_48.setParamFlag(HabboWindowParam.const_36,true);
            this.var_48.procedure = this.onPopup;
         }
         Util.hideChildren(this.var_48);
         this.refreshContent(this.var_48);
         this.var_48.height = Util.getLowestPoint(this.var_48) + 5;
         var _loc2_:Point = new Point();
         param1.getGlobalPosition(_loc2_);
         this.var_48.x = _loc2_.x + this.var_2105 + param1.width;
         this.var_48.y = _loc2_.y - this.var_48.height * 0.5 + param1.height * 0.5;
         var _loc3_:Point = new Point();
         this.var_48.getGlobalPosition(_loc3_);
         if(_loc3_.x + this.var_48.width > this.var_48.desktop.width)
         {
            this.var_48.x = -this.var_48.width + _loc2_.x + this._popupIndentLeft;
      ...
      private function onPopup(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(!Util.containsMouse(this.var_48))
            {
               this.closePopup();
            }
         }

package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1008:RoomLayout;
      
      private var var_549:Timer;
      
      private var var_1550:Boolean = true;
      
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         this._navigator = param1;
         this.var_549 = new Timer(100);
         this.var_549.addEventListener(TimerEvent.TIMER,this.updateArrowPos);
         ...
         this.var_38.push(new RoomLayout(HabboClubLevelEnum.const_60,80,"g"));
         this.var_38.push(new RoomLayout(HabboClubLevelEnum.const_60,74,"h"));
         this.var_38.push(new RoomLayout(HabboClubLevelEnum.const_60,416,"o"));
         this.var_38.push(new RoomLayout(HabboClubLevelEnum.const_60,352,"p"));
         this.var_38.push(new RoomLayout(HabboClubLevelEnum.const_60,304,"q"));
         this.var_38.push(new RoomLayout(HabboClubLevelEnum.const_60,336,"r"));
         this.var_38.push(new RoomLayout(HabboClubLevelEnum.const_60,748,"u"));
         this.var_38.push(new RoomLayout(HabboClubLevelEnum.const_60,438,"v"));
      ...
      public function dispose() : void
      {
         if(this.var_549)
         {
            this.var_549.removeEventListener(TimerEvent.TIMER,this.updateArrowPos);
            this.var_549.reset();
            this.var_549 = null;
         }
      }
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1008.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_1550 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_1550 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_154 = IWindowContainer(this._navigator.getXmlWindow("roc_create_room"));
         this.var_54 = IItemListWindow(this.var_154.findChildByName("item_list"));
         ...
         var _loc1_:IWindow = this.var_154.findChildByTag("close");
         _loc1_.procedure = this.onCancelButtonClick;
         this.var_1009 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_154.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
         var _loc2_:Rectangle = Util.getLocationRelativeTo(this.var_154.desktop,this.var_154.width,this.var_154.height);
         this.var_154.x = _loc2_.x;
         this.var_154.y = _loc2_.y;
      }
      
      public function refresh() : void
      {
         this.var_1009.goBackToInitialState();
         this.var_1009.input.textBackgroundColor = 4294967295;
         this.var_1008 = this.var_38[0];
         this.refreshRoomThumbnails();
      ...
      {
         return IWindowContainer(this._navigator.windowManager.createWindow("","",HabboWindowType.const_56,HabboWindowStyle.const_34,HabboWindowParam.const_58,new Rectangle(0,0,100,300)));
      }
      
      private function isMandatoryFieldsFilled() : Boolean
      {
         var _loc1_:Boolean = this.var_1009.checkMandatory(this._navigator.getText("navigator.createroom.nameerr"));
         return Boolean(_loc1_);
      }
      
      private function getCreateButton() : IButtonWindow
      {
         return IButtonWindow(this.var_154.findChildByName("create_button"));
      }
      
      private function getCancelButton() : IButtonWindow
      {
         return IButtonWindow(this.var_154.findChildByName("back_button"));
      }
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_1009.getText();
         var _loc4_:String = "model_" + this.var_1008.name;

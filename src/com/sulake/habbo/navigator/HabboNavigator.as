package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_272:MainViewCtrl;
      
      private var var_566:RoomInfoViewCtrl;
      
      private var var_1045:RoomCreateViewCtrl;
      
      private var _data:NavigatorData;
      
      private var var_397:Tabs;
      
      private var _assetLibrary:IAssetLibrary;
      
      private var var_2692:Dictionary;
      ...
      private var var_883:GuestRoomPasswordInput;
      
      private var var_328:GuestRoomDoorbell;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_272 = new MainViewCtrl(this);
         this.var_566 = new RoomInfoViewCtrl(this);
         this.var_1045 = new RoomCreateViewCtrl(this);
         this.var_2254 = new RoomThumbnailRenderer(this);
         this.var_883 = new GuestRoomPasswordInput(this);
         this.var_328 = new GuestRoomDoorbell(this);
         this.var_397 = new Tabs(this);
      ...
      public function getButton(param1:String, param2:String, param3:Function, param4:int = 0, param5:int = 0, param6:int = 0) : IBitmapWrapperWindow
      {
         ...
         var _loc8_:IBitmapWrapperWindow = IBitmapWrapperWindow(this._windowManager.createWindow(param1,"",HabboWindowType.const_289,HabboWindowStyle.const_37,0 | 0,new Rectangle(param4,param5,_loc7_.width,_loc7_.height),param3,param6));
      ...
      private function onToolbarReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_566.registerToolbarEvents();
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_106,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.homeRoomId > 0)
            {
               this._toolbar.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_106,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            this._toolbar.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_46,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      {
         var _loc1_:Boolean = this.var_272.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         this.var_272.startSearch(Tabs.const_210,Tabs.const_369,param1);
         this.var_272.mainWindow.activate();
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         this.var_272.startSearch(Tabs.const_304,Tabs.const_212);
         this.var_397.getTab(Tabs.const_304).tabPageDecorator.tabSelected();
      }

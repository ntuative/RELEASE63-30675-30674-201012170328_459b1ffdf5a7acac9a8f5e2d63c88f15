package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private static const const_1578:String = "no_reqs_info";
      ...
      private var var_1855:IContainerButtonWindow;
      
      private var var_1854:IContainerButtonWindow;
      ...
      {
         this.var_1855 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         this.var_1854 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         this.var_1854.procedure = this.onDismissAllButtonClick;
         this.var_1855.procedure = this.onAcceptAllButtonClick;
         this.refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_157)
         {
      ...
      public function addRequest(param1:FriendRequest) : void
      {
         ...
         this.var_54.addListItem(param1.view);
         this._friendList.friendRequests.refreshShading();
         this.refreshButtons();
      }
      ...
      public function removeRequest(param1:FriendRequest) : void
      {
         ...
         this.var_54.removeListItem(param1.view);
         this.refreshButtons();
      }
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_377;
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         _loc2_.state = FriendRequest.const_375;
         ...
         if(this._friendList && this._friendList.events)
         {
            this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_268,param1));
         }
      }
      ...
      private function onDismissAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_377 && _loc4_.state != FriendRequest.const_375)
            {
               _loc4_.state = FriendRequest.const_375;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
                  this._friendList.events.dispatchEvent(new FriendRequestEvent(FriendRequestEvent.const_268,_loc4_.requestId));
               }
            }
         }
         this.refresh();
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         for each(_loc4_ in this._friendList.friendRequests.requests)
         {
            if(_loc4_.state != FriendRequest.const_377 && _loc4_.state != FriendRequest.const_375)
            {
               ...
               _loc4_.state = FriendRequest.const_377;
               this.refreshRequestEntry(_loc4_);
               if(this._friendList && this._friendList.events)
               {
      ...
      private function refreshButtons() : void
      {
         ...
         this.setEnabled(this.var_1855,_loc1_);
         this.setEnabled(this.var_1854,_loc1_);
      }

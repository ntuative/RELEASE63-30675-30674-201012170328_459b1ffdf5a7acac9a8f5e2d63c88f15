package com.sulake.habbo.friendlist
{
   ...
   public class FriendsView implements ITabView, IFriendsView
   {
      ...
      public static const const_686:String = "bg";
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2460:IContainerButtonWindow;
      
      private var var_2462:IContainerButtonWindow;
      
      private var var_2461:IContainerButtonWindow;
      
      private var var_2459:IContainerButtonWindow;
      ...
      public function init(param1:HabboFriendList) : void
      {
         ...
         this.var_361 = new AvatarPopupCtrl(this._friendList);
      }
      ...
      {
         this.var_2460 = this.initButton("open_minimail",this.onMinimailButtonClick,param1);
         this.var_2462 = this.initButton("open_homepage",this.onHomeButtonClick,param1);
         this.var_2461 = this.initButton("room_invite",this.onInviteButtonClick,param1);
         this.var_2459 = this.initButton("remove_friend",this.onRemoveButtonClick,param1);
         this.refreshButtons();
      }
      ...
      {
         this._friendList.tabs.findTab(FriendListTab.const_92).setNewMessageArrived(true);
      }
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:FriendCategory, param4:Friend) : Boolean
      {
         ...
         var _loc6_:IWindowContainer = this.var_54.getListItemAt(param2) as IWindowContainer;
         if(_loc6_ == null)
         {
            if(!param1)
            {
         ...
         _loc6_.height = 20;
         _loc6_.visible = true;
         var _loc7_:IWindow = _loc6_.findChildByName(const_686);
         _loc7_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_92,_loc5_);
         if(param4 == null)
         {
            param3.view = _loc6_;
      ...
      public function refreshCategoryEntry(param1:FriendCategory, param2:Boolean) : void
      {
         ...
         var _loc4_:IWindow = _loc3_.findChildByName(const_686);
      ...
      {
         return this._friendList.laf.getRowShadingColor(FriendListTab.const_92,param1);
      }
      
      private function refreshButtons() : void
      {
         var _loc1_:Array = this._friendList.categories.getSelectedFriends();
         this.setEnabled(this.var_2460,this.isEnableMinimailButton(_loc1_));
         this.setEnabled(this.var_2462,this.isEnableHomeButton(_loc1_));
         this.setEnabled(this.var_2461,this.isEnableInviteButton(_loc1_));
         this.setEnabled(this.var_2459,this.isEnableRemoveButton(_loc1_));
      }
      ...
      private function onFriendClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            this.var_361.showPopup(this._friendList.view.mainWindow,_loc3_.view);
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_361.closePopup();
         }
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK || param1.type == WindowMouseEvent.const_295)
         {
            _loc4_ = this._friendList.categories.findFriend(param2.id);
            _loc4_.selected = !_loc4_.selected;
            this.refreshButtons();
            this.refreshList();
            if(param1.type == WindowMouseEvent.const_295 && _loc4_.online)
            {
      ...
      private function refreshPageLink(param1:IWindowContainer, param2:int, param3:int, param4:Boolean) : void
      {
         ...
         _loc6_.color = this._friendList.laf.getRowShadingColor(FriendListTab.const_92,param4);
         _loc6_.visible = true;
      }

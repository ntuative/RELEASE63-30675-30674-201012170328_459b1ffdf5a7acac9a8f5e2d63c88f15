   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this._container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_145,this.onFigureUpdate);
               this._container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_156,this.onPetInfo);
         ...
         if(this._container.roomSessionManager != null)
         {
            this._container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_145,this.onFigureUpdate);
            this._container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_156,this.onPetInfo);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_627.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = this.var_627.getValue(_loc2_);
               if(_loc3_)
               {
                  _loc3_.dispose();
               }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_315);
         _loc1_.push(RoomWidgetUserActionMessage.const_742);
         _loc1_.push(RoomWidgetUserActionMessage.const_609);
         _loc1_.push(RoomWidgetUserActionMessage.const_659);
         _loc1_.push(RoomWidgetUserActionMessage.const_655);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_603);
         _loc1_.push(RoomWidgetUserActionMessage.const_737);
         _loc1_.push(RoomWidgetUserActionMessage.const_692);
         _loc1_.push(RoomWidgetUserActionMessage.const_613);
         _loc1_.push(RoomWidgetFurniActionMessage.const_260);
         _loc1_.push(RoomWidgetFurniActionMessage.const_661);
         _loc1_.push(RoomWidgetFurniActionMessage.const_764);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_644);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_660);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1298);
         _loc1_.push(RoomWidgetPetCommandMessage.const_688);
         _loc1_.push(RoomWidgetPetCommandMessage.const_650);
         _loc1_.push(RoomWidgetUserActionMessage.const_457);
         _loc1_.push(RoomWidgetUserActionMessage.const_337);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            else if(param1.type == RoomWidgetUserActionMessage.const_337 || param1.type == RoomWidgetUserActionMessage.const_457 || param1.type == RoomWidgetUserActionMessage.const_415)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_315:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetUserActionMessage.const_742:
            ...
            case RoomWidgetUserActionMessage.const_609:
               ...
               break;
            case RoomWidgetUserActionMessage.const_457:
               this._container.sessionDataManager.givePetRespect(_loc2_);
               break;
            case RoomWidgetUserActionMessage.const_659:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1038,_loc3_.name);
               this._container.events.dispatchEvent(_loc8_);
               break;
            case RoomWidgetUserActionMessage.const_655:
            ...
            case RoomWidgetUserActionMessage.const_614:
               ...
               break;
            case RoomWidgetUserActionMessage.const_603:
               this._container.roomSession.assignRights(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_737:
               this._container.roomSession.removeRights(_loc3_.webID);
               break;
            case RoomWidgetUserActionMessage.const_692:
            ...
            case RoomWidgetUserActionMessage.const_415:
               ...
               break;
            case RoomWidgetFurniActionMessage.const_661:
            ...
            case RoomWidgetRoomTagSearchMessage.const_644:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_660:
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_777);
               _loc6_.id = param1.id;
               ...
               {
                  _loc22_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_357);
               ...
               _loc9_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_995);
               _loc10_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_1023);
            ...
            case RoomObjectCategoryEnum.OBJECT_CATEGORY_USER:
               ...
               if(_loc11_.type == RoomObjectTypeEnum.const_220)
               {
                  this._container.roomSession.userDataManager.requestPetInfo(_loc11_.webID);
                  return null;
               }
               if(_loc11_.type == RoomObjectTypeEnum.const_352)
               {
                  _loc12_ = "null";
               ...
               {
                  if(_loc11_.type != RoomObjectTypeEnum.const_934)
                  {
                     return null;
                  }
                  _loc12_ = "null";
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.const_236)
               {
                  ...
                  if(_loc16_ != null)
                  {
                     _loc30_ = _loc16_.getModel().getString(RoomObjectVariableEnum.const_699);
                  ...
                  _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1432;
                  if(!_loc25_)
                  {
                  ...
                  if(!_loc26_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_913;
                  }
                  if(!_loc27_)
                  {
                     _loc13_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1067;
                  }
               ...
               if(_loc12_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc14_.push(RoomWidgetUserInfoUpdateEvent.const_1365);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = this.var_627.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = this._container.avatarRenderManager.createPetImageFromFigure(_loc4_,AvatarScaleType.const_48);
            this.var_627.add(_loc2_.petId,_loc5_);
         }
         if(_loc5_ == null)
         {
         ...
         if(this._container != null && this._container.events != null)
         {
            ...
            if(_loc13_ != null)
            {
               ...
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_699);

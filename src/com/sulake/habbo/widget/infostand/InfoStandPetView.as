package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private var var_189:IBorderWindow;
      
      private var var_62:IItemListWindow;
      
      private var var_50:IItemListWindow;
      
      private var var_178:PetCommandTool;
      
      private var var_1214:Map;
      
      private var var_587:int;
      
      private const const_1817:int = 158;
      
      private const const_1814:int = 16;
      
      private const const_1812:uint = 11184810;
      
      private const const_1815:uint = 6710886;
      
      private const const_1813:uint = 3355443;
      
      private const const_1816:String = "level";
      
      private const const_1810:String = "experience";
      
      private const const_1811:String = "energy";
      
      private const const_1818:String = "nutrition";
      ...
      {
         if(this.var_50 == null || this.var_189 == null || this.var_62 == null)
         {
            return;
         }
         this.var_62.width = this.var_62.scrollableRegion.width;
         this.var_62.visible = this.var_62.width > 0;
         this.var_50.height = this.var_50.scrollableRegion.height;
         this.var_189.height = this.var_50.height + 20;
         this._window.width = Math.max(this.var_189.width,this.var_62.width);
         this._window.height = this._window.scrollableRegion.height;
         if(this.var_189.width < this.var_62.width)
         {
            this.var_189.x = this._window.width - this.var_189.width;
            this.var_62.x = 0;
         }
         else
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(this.const_1816,param1.level,param1.levelMax);
         this.updateStateElement(this.const_1810,param1.experience,param1.experienceMax);
         this.updateStateElement(this.const_1811,param1.energy,param1.energyMax);
         this.updateStateElement(this.const_1818,param1.nutrition,param1.nutritionMax);
         ...
         this.var_1214.remove(param1.id);
         this.var_1214.add(param1.id,param1);
         if(this.var_178 && this.var_178.isVisible() && param1.isOwnPet)
         {
            this.var_178.showCommandToolForPet(param1.id,param1.name,param1.image);
         }
      }
      ...
      public function updateEnabledTrainingCommands(param1:int, param2:Array) : void
      {
         ...
         this.var_178.setEnabledCommands(param1,param2);
      }
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(this.const_1817,this.const_1814,false);
         _loc5_.fillRect(new Rectangle(0,0,_loc5_.width,_loc5_.height),this.const_1812);
         var _loc6_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc5_.fillRect(_loc6_,this.const_1813);
         var _loc7_:Rectangle = new Rectangle(1,1,_loc5_.width - 2,_loc5_.height - 2);
         _loc7_.width = _loc3_ * _loc7_.width;
         _loc5_.fillRect(_loc7_,this.const_1815);
         return _loc5_;
      }
      ...
      private function openTrainView() : void
      {
         if(this.var_178 == null)
         {
            this.var_178 = new PetCommandTool(this._widget);
         }
         var _loc1_:InfoStandPetData = this.var_1214.getValue(this.var_587) as InfoStandPetData;
         if(_loc1_ != null)
         {
            this.var_178.showWindow(true);
            this.var_178.showCommandToolForPet(_loc1_.id,_loc1_.name,_loc1_.image);
         }
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         this.var_189 = this._window.getListItemByName("info_border") as IBorderWindow;
         if(this.var_189 != null)
         {
            this.var_50 = this.var_189.findChildByName("infostand_element_list") as IItemListWindow;
         }
         this._window.name = param1;
         this._widget.mainContainer.addChild(this._window);
         var _loc3_:IWindow = this.var_189.findChildByTag("close");
         if(_loc3_ != null)
         {
         ...
         {
            _loc9_ = this.var_62.getListItemAt(_loc4_) as IRegionWindow;
            if(_loc9_ != null)
            {
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_189.findChildByName("petrespect_icon") as IBitmapWrapperWindow;
         if(_loc6_ != null)
         {
         ...
         var _loc7_:* = [];
         this.var_62.groupListItemsWithTag("CMD_BUTTON",_loc7_,true);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_178 && this.var_178.getPetId() == this.var_587)
               {
                  this.var_178.showWindow(false);
               }
               break;
            case "btn_train":
               this.openTrainView();
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_474,this._widget.petData.ownerId);
      ...
      private function updateRespectButton() : void
      {
         ...
         var _loc1_:IRegionWindow = this.var_62.getListItemByName("petrespect") as IRegionWindow;
         if(_loc1_ == null)
         {
            return;
         }

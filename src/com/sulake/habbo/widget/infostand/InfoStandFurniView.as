package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandFurniView
   {
      ...
      private function createWindow(param1:String) : void
      {
         ...
         {
            _loc5_ = 0;
            while(_loc5_ < this.var_62.numListItems)
            {
               _loc4_ = this.var_62.getListItemAt(_loc5_);
               _loc4_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onButtonClicked);
               _loc5_++;
            }
         }
         this.var_875 = this.var_189.findChildByTag("catalog");
         if(this.var_875 != null)
         {
            this.var_875.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onCatalogButtonClicked);
         }
      }
      ...
      public function update(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         this.var_62.visible = _loc2_ || _loc3_ || _loc4_;
         this.updateWindow();
      }
      ...
      private function showCatalogButton(param1:Boolean) : void
      {
         if(param1)
         {
            ...
            {
               this.var_50.addListItem(this.var_875);
            }
            this.var_875.visible = param1;
         }
         else
         {
            this.var_50.removeListItem(this.var_875);
         }
      }
   }
}

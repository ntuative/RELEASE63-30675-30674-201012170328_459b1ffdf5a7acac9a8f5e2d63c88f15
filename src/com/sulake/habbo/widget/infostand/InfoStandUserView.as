package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandUserView
   {
      ...
      protected function createWindow(param1:String, param2:Boolean) : void
      {
         ...
         var _loc6_:IBitmapWrapperWindow = this.var_189.findChildByName("home_icon") as IBitmapWrapperWindow;
         ...
         var _loc7_:IWindow = this.var_189.findChildByTag("close");
         if(_loc7_ != null)
         {
         ...
         while(_loc8_ < 5)
         {
            _loc10_ = this.var_189.findChildByName("badge_" + _loc8_);
            if(_loc10_ != null)
            {
         ...
         _loc10_ = this.var_189.findChildByName("badge_group");
      ...
      private function showGroupBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         _loc3_ = this.var_115.getChildByName("name") as ITextWindow;
         if(_loc3_ != null)
         {
            _loc3_.text = "Group Info";
         }
         _loc4_ = this.var_115.getChildByName("description") as ITextWindow;
         if(_loc4_ != null)
         {
         ...
         this.var_115.x = _loc5_.left - this.var_115.width;
         this.var_115.y = _loc5_.top + (_loc5_.height - this.var_115.height) / 2;
      }
      ...
      private function showBadgeInfo(param1:WindowMouseEvent) : void
      {
         ...
         this.createBadgeDetails();
         _loc6_ = this.var_115.getChildByName("name") as ITextWindow;
         if(_loc6_ != null)
         {
            _loc6_.text = this._widget.localizations.getBadgeName(_loc5_);
         }
         _loc6_ = this.var_115.getChildByName("description") as ITextWindow;
         if(_loc6_ != null)
         {
         ...
         this.var_115.x = _loc7_.left - this.var_115.width;
         this.var_115.y = _loc7_.top + (_loc7_.height - this.var_115.height) / 2;
      }
      ...
      private function createBadgeDetails() : void
      {
         ...
         this.var_115 = this._widget.windowManager.buildFromXML(_loc1_.content as XML) as IBorderWindow;
         if(this.var_115 == null)
         {
            throw new Error("Failed to construct window from XML!");
         }
      ...
      protected function updateButtons(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetUserInfoUpdateEvent.const_229:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_236:
      ...
      protected function setTradeButtonTooltip(param1:int) : void
      {
         ...
         switch(param1)
         {
            case RoomWidgetUserInfoUpdateEvent.TRADE_REASON_NO_OWN_RIGHT:
               ...
               break;
            case RoomWidgetUserInfoUpdateEvent.const_913:
               _loc2_ = "${infostand.button.trade.tooltip.shutdown}";
               break;
            case RoomWidgetUserInfoUpdateEvent.const_1067:

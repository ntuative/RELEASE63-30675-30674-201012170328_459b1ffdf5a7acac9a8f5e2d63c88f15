package com.sulake.habbo.widget.infostand
{
   ...
   public class PetCommandTool
   {
      ...
      private var var_385:IFrameWindow;
      ...
      private const const_1841:int = 1100;
      
      public function PetCommandTool(param1:InfostandWidget)
      {
         super();
         this._widget = param1;
         this.var_1075 = new Map();
         this.var_386 = new Timer(this.const_1841);
      ...
      public function showCommandToolForPet(param1:int, param2:String, param3:BitmapData = null) : void
      {
         ...
         var _loc6_:Array = this.var_1075.getValue(param1) as Array;
         if(_loc6_ == null)
         {
      ...
      {
         var _loc2_:Array = this.var_1075.getValue(this.var_587) as Array;
      ...
      {
         this.var_1075.remove(param1);
         this.var_1075.add(param1,param2);
      ...
      {
         var _loc2_:RoomWidgetPetCommandMessage = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_650,param1);
      ...
      private function openInfoWindow() : void
      {
         ...
         if(this.var_385 == null)
         {
            ...
            this.var_385 = (this._widget.windowManager as ICoreWindowManager).buildFromXML(_loc1_.content as XML) as IFrameWindow;
            if(this.var_385 == null)
            {
               throw new Error("Failed to construct command info window from XML!");
            }
            this.var_385.x = 200;
            this.var_385.procedure = this.onInfoWindowProcedure;
         }
         else
         {
      ...
      private function onCommandWindowProcedure(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(_loc3_ != null && _loc3_.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this._widget.messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_337,this.var_587));
            }
            else if(param2.name.indexOf("btn_cmd_") > -1)
            {
               ...
               _loc7_ = new RoomWidgetPetCommandMessage(RoomWidgetPetCommandMessage.const_688,this.var_587,this.var_2394 + " " + _loc6_);

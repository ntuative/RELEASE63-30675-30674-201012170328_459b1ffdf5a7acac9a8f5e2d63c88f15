package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1203:XML;
      
      private var _widget:DimmerFurniWidget;
      
      private var var_528:DimmerViewColorGrid;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_56,HabboWindowStyle.const_34,0 | 0,new Rectangle(const_1124,const_1125,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_528 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
         ...
         this.var_240 = ITabContextWindow(this._window.findChildByName("tab_context"));
         this.method_6(this._widget.selectedPresetIndex);
         var _loc2_:int = 0;
         while(_loc2_ < this.var_240.numTabItems)
         {
            _loc6_ = this.var_240.getTabItemAt(_loc2_);
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1204 = _loc2_.light;
         if(this.var_356 != null)
         {
            this.var_356.setValue(this.var_1204);
         }
         this.var_498 = this.colors.indexOf(_loc2_.color);
         if(this.var_528 != null)
         {
            this.var_528.setSelectedColorIndex(this.var_498);
         }
         this.selectedType = _loc2_.type;
         this._widget.previewCurrentSetting();
      }
      
      private function method_6(param1:int) : void
      {
         if(this.var_240 == null)
         {
            return;
         }
         var _loc2_:IWindow = this.var_240.getTabItemAt(param1);
         if(_loc2_ != null)
         {
            this.var_240.selector.setSelected(_loc2_ as ISelectableWindow);
         }
      }
      ...
      private function getSelectedTabIndex() : int
      {
         ...
         var _loc1_:ISelectableWindow = this.var_240.selector.getSelected();
         return this.var_240.selector.getSelectableIndex(_loc1_);
      }
      ...
      private function get windowXML() : XML
      {
         ...
         this.var_1203 = XML(_loc1_.content);
         return this.var_1203;
      }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_528 != null)
         {
            this.var_528.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }

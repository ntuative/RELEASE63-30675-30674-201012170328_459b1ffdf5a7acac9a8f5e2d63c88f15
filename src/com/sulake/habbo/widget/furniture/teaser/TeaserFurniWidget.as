package com.sulake.habbo.widget.furniture.teaser
{
   ...
   public class TeaserFurniWidget extends RoomWidgetBase
   {
      ...
      private const const_1541:int = 2;
      
      private const const_1540:int = 3;
      
      private const const_1823:int = 0;
      
      private const const_1819:int = 1;
      
      private const const_1820:int = 2;
      
      private const const_1822:String = "xmas10_dialog_bg_png";
      
      private const const_1543:String = "xmas10_dialog_telepair_png";
      
      private const const_1154:String = "xmas10_present_dialog_img_png";
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_488,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_694,this.onObjectUpdate);
         param1.addEventListener(RoomWidgetTeaserDataUpdateEvent.const_808,this.onObjectUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetTeaserDataUpdateEvent.const_488,this.onObjectUpdate);
      }
      ...
      private function onObjectUpdate(param1:RoomWidgetTeaserDataUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetTeaserDataUpdateEvent.const_488:
               _loc2_ = this.const_1542;
               this.var_1234 = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_808:
               ...
               this.var_1234 = null;
               break;
            case RoomWidgetTeaserDataUpdateEvent.const_694:
               _loc2_ = this.const_1544;
               this.var_293 = param1.objectId;
               this.var_1234 = param1.data;
         ...
         if(this.var_1235 != _loc2_ && this._window)
         {
            this._window.dispose();
            this._window = null;
         }
         this.var_1235 = _loc2_;
         this.mainWindow;
         this.showInterface();
      }
         ...
         if(!this._window)
         {
            switch(this.var_1235)
            {
               ...
               case this.const_1544:
                  ...
                  else if(this._status == this.const_1820)
                  {
            ...
            if(_loc4_)
            {
               _loc3_ = (assets.getAssetByName(this.const_1822) as BitmapDataAsset).content as BitmapData;
      ...
      private function onTeaserOkButton(param1:WindowEvent) : void
      {
         ...
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_600);
      ...
      private function onPostButton(param1:WindowEvent) : void
      {
         ...
         HabboWebTools.facebookViralGiftPost(_loc2_,_loc3_,this.var_1234,_loc4_);
         this.hideInterface();
      }
      ...
      private function onOpenButton(param1:WindowEvent) : void
      {
         ...
         if(messageListener != null)
         {
            _loc2_ = new RoomWidgetViralFurniMessage(RoomWidgetViralFurniMessage.const_155);
            _loc2_.objectId = this.var_293;
            messageListener.processWidgetMessage(_loc2_);
         }
         this.hideInterface();
      ...
      private function sendConversionPoint(param1:String, param2:String, param3:String = "") : void
      {
         ...
         if(messageListener != null)
         {
            _loc4_ = new RoomWidgetConversionPointMessage(RoomWidgetConversionPointMessage.const_645,"ViralGift",param1,param2,param3);

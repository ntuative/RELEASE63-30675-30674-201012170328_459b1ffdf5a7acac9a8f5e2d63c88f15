package com.sulake.habbo.widget.friendrequest
{
   ...
   public class FriendRequestDialog
   {
      ...
      public function set targetRect(param1:Rectangle) : void
      {
         ...
         if(!param1)
         {
            this._widget.ignoreRequest(this.var_1079);
            return;
         }
         if(this.var_1729 || this.var_1728)
         {
            return;
         }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK:
               ...
               {
                  case "accept_button":
                     this._widget.acceptRequest(this.var_1079);
                     break;
                  case "decline_button":
                     this._widget.declineRequest(this.var_1079);
                     break;
                  case "close_button":
                     this._widget.ignoreRequest(this.var_1079);
               }

package com.sulake.habbo.quest
{
   ...
   public class Quest implements IDisposable
   {
      ...
      private var var_1632:Date;
      
      private var _localizationCode:String;
      
      private var var_184:Boolean = false;
      
      private var var_2239:uint = 2;
      
      private var var_2238:uint = 0;
      ...
      public function update(param1:QuestMessageData) : void
      {
         ...
         this.var_1583 = param1.roomItemTypeName;
         this.var_1582 = param1.rewardCurrencyAmount;
         this.var_1632 = new Date();
         this.var_1632.setTime(param1.endDateTimeStamp);
      ...
      private function itemGridEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            if(!this.var_184)
            {
               this.var_796.style = this.var_2238;
            }
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(!this.var_184)
            {
               this.var_796.style = this.var_2239;
            }
         }
      }

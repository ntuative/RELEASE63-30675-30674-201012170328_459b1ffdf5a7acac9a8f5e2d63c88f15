package com.sulake.habbo.quest
{
   ...
   public class QuestCampaign implements IDisposable
   {
      ...
      private var var_284:QuestView;
      
      private var _window:IFrameWindow;
      
      private var var_1126:IWindowContainer;
      ...
      public function QuestCampaign(param1:QuestController, param2:String, param3:int)
      {
         ...
         this._id = param2;
         this.var_1616 = param3;
         this.var_171 = new QuestHelp(this);
      }
      ...
      public function dispose() : void
      {
         ...
         for each(_loc1_ in this.var_733)
         {
            _loc1_.dispose();
         }
         this.var_733 = [];
      ...
      private function prepareWindow() : void
      {
         ...
         this._window.center();
         this.var_1126 = this._window.findChildByName("quest.container") as IWindowContainer;
         this.var_1387 = this._window.findChildByName("currency.container") as IWindowContainer;
         this.var_283 = this._window.findChildByName("quests") as IItemListWindow;
         var _loc1_:* = "icon_" + this.id + "_pixeltype";
         var _loc2_:IBitmapWrapperWindow = this.var_1387.findChildByName("currency.icon") as IBitmapWrapperWindow;
         this._controller.questEngine.setImageFromAsset(_loc2_,_loc1_,this.onPreviewImageReady);
         this.var_1387.findChildByName("currency.amount").caption = "${quest_" + this.id + ".currency}";
         ...
         this.var_1127 = this._window.findChildByName("help.button") as IWindowContainer;
         if(this.var_1127)
         {
            this.var_1127.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.helpButtonEventProc);
            this.var_1127.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.helpButtonEventProc);
            this.var_1127.addEventListener(WindowMouseEvent.const_25,this.helpButtonEventProc);
         }
      }
      ...
      private function openHelp() : void
      {
         ...
         if(this.var_171)
         {
            this.var_1126.addChild(this.var_171.view);
         }
      }
      
      public function updatePurse() : void
      {
         var _loc1_:int = this._controller.questEngine.getActivityPointsForType(this.var_1616);
      ...
      private function onPreviewImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc3_ = this.var_1387.findChildByName("currency.icon") as IBitmapWrapperWindow;
      ...
      public function openCampaign(param1:Array) : void
      {
         ...
         {
            this.var_340.push(new Quest(_loc2_,this));
         }
         _loc3_ = null;
         for each(_loc4_ in this.var_340)
         {
            this.var_283.addListItem(_loc4_.view);
            if(!_loc3_ && (_loc4_.status == QuestStatusEnum.const_41 || _loc4_.status == QuestStatusEnum.const_535))
            {
               _loc3_ = _loc4_;
            }
         }
         ...
         else if(this.var_340.length > 0)
         {
            this.activateListItem(this.var_340[0]);
         }
      }
      ...
      private function showQuestData(param1:Quest) : void
      {
         ...
         this.var_284 = new QuestView(this,param1);
         this.var_1126.addChild(this.var_284.view);
         this.var_284.init();
      }
      ...
      {
         this.modifyQuestData(param1);
         this.var_733.push(new QuestCompleted(this,param1));
      }
      ...
      public function closeQuestCompleted(param1:QuestCompleted) : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         for each(_loc3_ in this.var_733)
         {
            if(_loc3_ == param1)
            {
               _loc2_ = _loc3_;
         ...
         {
            _loc2_.dispose();
            _loc4_ = this.var_733.indexOf(_loc2_);
            if(_loc4_ >= 0)
            {
               this.var_733.splice(_loc4_,1);
            }
         }
      }

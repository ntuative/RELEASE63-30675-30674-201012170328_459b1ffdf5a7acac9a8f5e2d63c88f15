package com.sulake.habbo.avatar
{
   ...
   public class PetImage implements IAvatarImage, IDisposable
   {
      ...
      private var var_511:IAvatarDataContainer;
      ...
      public function setDirection(param1:String, param2:int) : void
      {
         ...
         if(param1 == AvatarSetType.const_43)
         {
            ...
            _loc3_ = this._structure.renderManager.petDataManager.getPetData(this.var_1377);
            if(_loc3_ != null)
            {
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         var _loc4_:AvatarCanvas = this._structure.getCanvas(this._scale,this.var_255.definition.geometryType);
         if(this.var_39 == null || _loc4_ != null && (this.var_39.width != _loc4_.width || this.var_39.height != _loc4_.height))
         {
            _loc4_ = this._structure.getCanvas(this._scale,this.var_255.definition.geometryType);
            if(_loc4_ == null)
            {
               return null;
            }
         ...
         while(_loc7_ >= 0)
         {
            ...
            if(_loc9_ && _loc9_.image && _loc9_.regPoint)
            {
               ...
               _loc16_ = this.var_1377 < 3;
               _loc17_ = !!_loc16_ ? 32 : 67;
               if(this._scale == AvatarScaleType.const_81)
               {
      ...
      public function appendAction(param1:String, ... rest) : Boolean
      {
         ...
         this.var_466 = this.var_466 + param1 + _loc3_;
         switch(param1)
         {
      ...
      private function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_289.push(new ActiveActionData(param1,param2));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.setActionToParts(this.var_890);
         this.getCache().resetBodyPartCache(this.var_890);
         return true;
      }
      ...
      private function sortActions() : void
      {
         ...
         this.var_1376 = this._structure.sortActions(this.var_289);
         ...
         {
            this.var_684 = this._structure.getCanvasOffsets(this.var_1376,this._scale,this.var_84);
         }
      }
      ...
      private function setActionsToParts() : void
      {
         var _loc1_:* = null;
         var _loc2_:* = null;
         for each(_loc1_ in this.var_1376)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.actionType == AvatarAction.const_380)
               {
                  this.var_857 = true;
               }
               if(_loc1_.actionType == AvatarAction.const_211)
               {
                  this.var_857 = true;
               }
         ...
         if(_loc2_ != null)
         {
            ...
            if(_loc3_ != null)
            {
               for each(_loc4_ in _loc3_.parts)
               {
                  if(_loc4_.type == "pbd")
                  {
                     this.var_1378 = _loc4_.id;
                     this.var_1802 = _loc4_.breed;
                     break;
                  }
               }
            }

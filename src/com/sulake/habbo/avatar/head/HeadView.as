   ...
   public class HeadView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_34)
         {
            ...
            var_34["null"] = new AvatarEditorGridView(var_63,FigureData.const_179,_windowManager,_assetLibrary);
            var_34["null"] = new AvatarEditorGridView(var_63,FigureData.const_233,_windowManager,_assetLibrary);
            var_34["null"] = new AvatarEditorGridView(var_63,FigureData.const_241,_windowManager,_assetLibrary);
            var_34["null"] = new AvatarEditorGridView(var_63,FigureData.const_221,_windowManager,_assetLibrary);
            var_34["null"] = new AvatarEditorGridView(var_63,FigureData.const_255,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_63 && var_128 == "")
         {
            var_63.switchCategory(FigureData.const_179);
         }
      }

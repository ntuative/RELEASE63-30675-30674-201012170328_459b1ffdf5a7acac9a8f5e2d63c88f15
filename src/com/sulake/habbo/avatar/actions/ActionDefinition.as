package com.sulake.habbo.avatar.actions
{
   ...
   public class ActionDefinition implements IActionDefinition
   {
      ...
      public function ActionDefinition(param1:XML)
      {
         ...
         this.var_408 = new Dictionary();
         this.var_1682 = new Dictionary();
         super();
         this._id = String(param1.@id);
         this._state = String(param1.@state);
         this.var_2337 = parseInt(param1.@precedence);
         this.var_2339 = String(param1.@activepartset);
         this.var_2334 = String(param1.@assetpartdefinition);
         this.var_2340 = String(param1.@lay);
         this.var_726 = String(param1.@geometrytype);
         this.var_2338 = Boolean(parseInt(param1.@main));
         this.var_2335 = Boolean(parseInt(param1.@HabboNavigatorCom_arrow_down_white_png));
         this.var_2341 = Boolean(parseInt(param1.@animation));
         ...
         for each(_loc3_ in param1.param)
         {
            ...
            if(_loc5_ == "HabboNavigatorCom_arrow_down_white_png")
            {
               this.var_2336 = _loc6_;
            }
            else
            {
               this.var_1682[_loc5_] = _loc6_;
            }
         }
         for each(_loc4_ in param1.type)
         {
            _loc7_ = String(_loc4_.@id);
            this.var_408[_loc7_] = new ActionType(_loc4_);
         }
      }
      ...
      public function setOffsets(param1:String, param2:int, param3:Array) : void
      {
         ...
         if(this.var_684.getValue(param1) == null)
         {
            this.var_684.add(param1,new Map());
         }
         var _loc4_:Map = this.var_684.getValue(param1);
      ...
      public function getOffsets(param1:String, param2:int) : Array
      {
         ...
         var _loc3_:Map = this.var_684.getValue(param1) as Map;
         if(_loc3_ == null)
         {
            return null;
         }
      ...
      public function getParameterValue(param1:String) : String
      {
         ...
         var _loc2_:String = this.var_1682[param1];
         if(_loc2_ == null)
         {
            _loc2_ = this.var_2336;
         }
         return _loc2_;
      }
      ...
      private function getTypePrevents(param1:String) : Array
      {
         ...
         var _loc2_:ActionType = this.var_408[param1];
         if(_loc2_ != null)
         {

   ...
   public class TorsoView extends CategoryBaseView implements IAvatarEditorCategoryView
   {
      ...
      override public function init() : void
      {
         ...
         if(!var_34)
         {
            ...
            var_34["null"] = new AvatarEditorGridView(var_63,FigureData.const_253,_windowManager,_assetLibrary);
            var_34["null"] = new AvatarEditorGridView(var_63,FigureData.const_177,_windowManager,_assetLibrary);
            var_34["null"] = new AvatarEditorGridView(var_63,FigureData.CHEST_ACCESSORIES,_windowManager,_assetLibrary);
            var_34["null"] = new AvatarEditorGridView(var_63,FigureData.const_252,_windowManager,_assetLibrary);
         }
         else
         {
         ...
         if(var_63 && var_128 == "")
         {
            var_63.switchCategory(FigureData.const_177);
         }
      }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "tab_jacket":
                  ...
                  break;
               case "tab_shirt":
                  this.switchCategory(FigureData.const_177);
                  break;

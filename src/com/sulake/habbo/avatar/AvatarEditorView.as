package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1155:IWindowContainer;
      
      public static var var_1418:IWindowContainer;
      
      public static var var_1882:int = 6710886;
      ...
      private var var_427:ITabSelectorWindow;
      
      private var _catalog:IHabboCatalog;
      
      private var var_426:IFrameWindow;
      
      private var var_355:Timer;
      
      private var var_1977:Number = 0;
      
      private var var_1976:Boolean = true;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager, param3:IHabboCatalog, param4:Array, param5:Boolean)
      {
         ...
         var _loc8_:* = null;
         this.var_951 = [];
         this.var_1202 = [AvatarEditorFigureCategory.const_608,AvatarEditorFigureCategory.const_43,AvatarEditorFigureCategory.const_214,AvatarEditorFigureCategory.const_623,AvatarEditorFigureCategory.const_1080,AvatarEditorFigureCategory.const_96];
         super();
         ...
         if(var_1155 == null)
         {
            ...
            var_1155 = this._controller.windowManager.buildFromXML(_loc7_.content as XML) as IWindowContainer;
         }
         if(var_1418 == null)
         {
            _loc8_ = this._controller.assets.getAssetByName("color_chooser_cell") as XmlAsset;
            var_1418 = this._controller.windowManager.buildFromXML(_loc8_.content as XML) as IWindowContainer;
         }
         this.var_355 = new Timer(1000);
         this.var_355.addEventListener(TimerEvent.TIMER,this.onUpdate);
         if(param4 == null)
         {
            param4 = this.var_1202;
         }
         for each(_loc6_ in param4)
         {
            this.var_951.push(_loc6_);
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_355.stop();
            this.var_355.removeEventListener(TimerEvent.TIMER,this.onUpdate);
            this.var_355 = null;
         }
      ...
      public function validateAvailableCategories(param1:Array) : Boolean
      {
         ...
         if(param1 == null)
         {
            return this.validateAvailableCategories(this.var_1202);
         }
         if(param1.length != this.var_951.length)
         {
            return false;
         }
         for each(_loc2_ in param1)
         {
            if(this.var_951.indexOf(_loc2_) < 0)
            {
               return false;
            }
         }
      ...
      private function onUpdate(param1:Event = null) : void
      {
         ...
         {
            this.var_1976 = this.canChangeOutfit();
            this.var_355.stop();
            if(this._window)
            {
      ...
      private function createWindow(param1:Boolean) : void
      {
         ...
         this.var_427 = this._window.findChildByName("mainTabs") as ITabSelectorWindow;
         var _loc2_:int = this.var_427.numSelectables - 1;
         while(_loc2_ >= 0)
         {
            _loc4_ = this.var_427.getSelectableAt(_loc2_);
            if(_loc4_ != null && this.var_951.indexOf(_loc4_.name) < 0)
            {
               _loc5_ = this.var_427.removeSelectable(_loc4_);
               _loc6_ = _loc2_ + 1;
               while(_loc6_ < this.var_427.numSelectables)
               {
                  this.var_427.getSelectableAt(_loc6_).x = this.var_427.getSelectableAt(_loc6_).x - _loc5_.width;
                  _loc6_++;
               }
            }
            _loc2_--;
      ...
      private function attachImages() : void
      {
         ...
         var _loc1_:Array = this.var_1202;
      ...
      public function update() : void
      {
         ...
         if(this._controller.sessionData && this._controller.sessionData.hasUserRight("fuse_use_wardrobe") && (this.var_1453 == AvatarEditorSideCategory.const_96 || this.var_1978))
         {
         ...
         this.setViewToCategory(this.var_297);
      }
      ...
      {
         if(this.var_1453 == AvatarEditorSideCategory.const_96)
         {
            this.var_1978 = false;
            this.setSideContent(AvatarEditorSideCategory.const_633);
         }
         else
         {
      ...
      private function setSideContent(param1:String) : void
      {
         ...
         switch(param1)
         {
            case AvatarEditorSideCategory.const_633:
               break;
            case AvatarEditorSideCategory.const_468:
               _loc3_ = this._controller.getSideContentWindowContainer(AvatarEditorSideCategory.const_468);
               break;
      ...
      private function displayStripClubDialog() : void
      {
         ...
         if(!this.var_426)
         {
            ...
            this.var_426 = this._windowManager.buildFromXML(_loc2_,2) as IFrameWindow;
            this.var_426.procedure = this.stripClubDialogEventProc;
            this.var_426.center();
         }
         else
         {

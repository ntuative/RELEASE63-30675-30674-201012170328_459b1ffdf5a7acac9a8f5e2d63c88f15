package com.sulake.habbo.notifications
{
   ...
   public class AchievementNotification
   {
      ...
      private const const_1840:String = "achievement_bg_001_png";
      ...
      public function AchievementNotification(param1:String, param2:int, param3:int, param4:int, param5:int, param6:int, param7:int, param8:IAssetLibrary, param9:IHabboWindowManager, param10:IHabboLocalizationManager, param11:IHabboConfigurationManager, param12:IHabboCommunicationManager, param13:ISessionDataManager)
      {
         ...
         this._window.center();
         this.var_2440 = this._localizations.getBadgeName(this.var_280);
         this.var_2437 = this._localizations.getBadgeDesc(this.var_280);
         this.var_2439 = this._localizations.getAchievementNameForFacebook(this.var_280,this.var_393.userName,this.var_393.realName,this.var_1346);
         this.var_2438 = this._localizations.getAchievementDescForFacebook(this.var_280,this.var_393.userName,this.var_393.realName,this.var_1346);
         this._desc = this.registerTextParameters("notifications.text.achievement");
         this.var_2442 = this.registerTextParameters("notifications.text.achievement_facebook");
         this._feedTitleFb = this.registerTextParameters("notifications.text.achievement_facebook_title");
         this._localizations.registerParameter("notifications.text.achievement.achievement_points","achievement_points",this.var_1507.toString());
         this._localizations.registerParameter("notifications.achievement.bonus.value","bonus_points",this.var_1347.toString());
         this._localizations.registerParameter("notifications.achievement.no_facebook","bonus_points",this.var_1347.toString());
         ...
         this._localizations.registerParameter(_loc16_,_loc17_,"" + this.var_2346);
         _loc15_.caption = this._localizations.getKey(_loc16_);
         this.setBadge(param13.getBadgeImage(param1),this.const_1566);
         var _loc18_:BitmapData = (param8.getAssetByName(this.const_1840) as BitmapDataAsset).content as BitmapData;
         ...
         if(this.var_1347 <= 0 || !_loc21_)
         {
            _loc22_.removeListItem(_loc23_);
            _loc22_.removeListItem(_loc25_);
            _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_280,"client.show.no_post"));
         }
         else
         {
            ...
            {
               _loc22_.removeListItem(_loc25_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_280,"client.show.post"));
            }
            else
            {
               _loc22_.removeListItem(_loc23_);
               _loc26_.send(new ConversionPointMessageComposer("Achievements",this.var_280,"client.show.no_fb"));
            }
         }
         var _loc27_:int = 32;
      ...
      {
         this._localizations.registerParameter(param1,"badge_name",this.var_2440);
         this._localizations.registerParameter(param1,"badge_desc",this.var_2437);
         this._localizations.registerParameter(param1,"badge_name_fb",this.var_2439);
         this._localizations.registerParameter(param1,"badge_desc_fb",this.var_2438);
         this._localizations.registerParameter(param1,"level",this.var_1346.toString());
         this._localizations.registerParameter(param1,"name",this.var_393.userName);
         return this._localizations.registerParameter(param1,"realname",this.var_393.realName);
      }
      ...
      private function onBadgeImageReady(param1:BadgeImageReadyEvent) : void
      {
         ...
         if(param1.badgeId != this.var_280)
         {
            return;
         }
      ...
      {
         HabboWebTools.facebookAchievementPost(this.var_280,this._feedTitleFb,this.var_2442,param1);
      }
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "post_to_facebook":
               _loc3_.send(new GetAchievementShareIdComposer(this.var_2441));
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_280,"client.start_post"));
               this._window.visible = false;
               break;
            case "close":
               _loc3_.send(new ConversionPointMessageComposer("Achievements",this.var_280,"client.skip_post"));
               this.dispose();
               return;
         }
      }

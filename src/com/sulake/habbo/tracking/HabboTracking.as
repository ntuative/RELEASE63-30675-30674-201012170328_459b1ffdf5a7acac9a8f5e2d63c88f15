package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_883:uint = 11;
      ...
      private var var_1154:IHabboWindowManager;
      
      private var _toolbar:IHabboToolbar;
      
      private var var_171:IHabboHelp;
      ...
      private var var_251:PerformanceTracker = null;
      
      private var var_619:FramerateTracker = null;
      
      private var var_252:LatencyTracker = null;
      
      private var var_617:LagWarningLogger = null;
      
      private var var_618:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_251 = new PerformanceTracker();
         this.var_619 = new FramerateTracker();
         this.var_252 = new LatencyTracker();
         this.var_617 = new LagWarningLogger();
         this.var_618 = new ToolbarClickTracker(this);
         this.var_1417 = new Array(const_883);
         var _loc4_:int = 0;
         while(_loc4_ < const_883)
         {
            this.var_1417[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1301,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1354,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1454,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_679,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_895,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1154)
            {
               this.var_1154.release(new IIDHabboWindowManager());
               this.var_1154 = null;
            }
            if(this.var_265)
            {
            ...
            if(this.var_186)
            {
               if(!this.var_186.disposed)
               {
                  ...
                  Component(this.var_186).events.removeEventListener(HabboFriendListTrackingEvent.const_361,this.onFriendlistTrackingEvent);
               }
            ...
            if(this.var_171)
            {
               if(!this.var_171.disposed)
               {
                  this.var_171.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
                  this.var_171.events.removeEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
               }
               this.var_171.release(new IIDHabboHelp());
               this.var_171 = null;
            }
            if(this._toolbar)
            {
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         if(this._configuration)
         {
            if(this.var_252 != null)
            {
               this.var_252.configuration = this._configuration;
            }
            if(this.var_251 != null)
            {
               this.var_251.configuration = this._configuration;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1300);
            if(this._configuration)
            {
               if(this.var_617 != null)
               {
                  this.var_617.configure(this._configuration);
               }
               if(this.var_619 != null)
               {
                  this.var_619.configure(this._configuration);
               }
               if(this.var_618 != null)
               {
                  this.var_618.configure(this._configuration);
               }
            }
         }
      }
      ...
      private function onCommunicationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(context).events.addEventListener(HabboCommunicationEvent.const_762,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_247,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_170,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_171,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_244,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboCommunicationEvent.const_248,this.onConnectionEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_601,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_61,this.onHotelViewEvent);
         Component(context).events.addEventListener(HabboHotelViewEvent.const_444,this.onHotelViewEvent);
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_251 != null)
            {
               this.var_251.connection = param1;
            }
            if(this.var_252 != null)
            {
               this.var_252.communication = this._communication;
               this.var_252.connection = param1;
            }
            if(this.var_617 != null)
            {
               this.var_617.connection = param1;
            }
         }
      }
      ...
      {
         if(param1.type == HabboHotelViewEvent.const_601)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1259);
         }
         else if(param1.type == HabboHotelViewEvent.const_444)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1371);
         }
         else if(param1.type == HabboHotelViewEvent.const_61)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1412);
         }
      }
      ...
      private function onConnectionEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            case HabboCommunicationEvent.INIT:
               this.trackLoginStep(HabboLoginTrackingStep.const_1406);
               break;
            case HabboCommunicationEvent.const_762:
               this.trackLoginStep(HabboLoginTrackingStep.const_1310,String(this._communication.port));
               break;
      ...
      {
         this.var_1154 = IHabboWindowManager(param2);
         if(this.var_1154)
         {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this._configuration)
            {
               if(this._configuration.keyExists("client.fatal.error.url"))
               {
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1417)
                  {
                  ...
                  if(this.var_251 != null)
                  {
                     _loc4_["null"] = this.var_251.flashVersion;
                     _loc4_["null"] = this.var_251.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1006);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1006,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_186).events.addEventListener(HabboFriendListTrackingEvent.const_361,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_361:
      ...
      {
         this.var_171 = param2 as IHabboHelp;
         this.var_171.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_CLOSED,this.onHelpTrackingEvent);
         this.var_171.events.addEventListener(HabboHelpTrackingEvent.HABBO_HELP_TRACKING_EVENT_DEFAULT,this.onHelpTrackingEvent);
      }
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2612)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1486);
            this.var_2612 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.guestRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_895,String(_loc2_.guestRoomId));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomObjectRoomAdEvent.const_296,this.onRoomAdClick);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_265 = param2 as IAdManager;
         this.var_265.events.addEventListener(AdEvent.const_432,this.onRoomAdLoad);
      }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_618)
         {
            this.var_618.track(param1.iconName);
         }
      }
      ...
      {
         this.var_617.chatLagDetected(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1858;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1858);
         }
         if(this.var_503 > -1 && _loc2_ - this.var_503 > 15000)
         {
            ++this.var_1857;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1857);
         }
         this.var_503 = _loc2_;
         if(this.var_251 != null)
         {
            this.var_251.update(param1,this.var_503);
         }
         if(this.var_252 != null)
         {
            this.var_252.update(param1,this.var_503);
         }
         if(this.var_619 != null)
         {
            this.var_619.trackUpdate(param1,this,this.var_503);
         }
         if(this.var_617 != null)
         {
            this.var_617.update(this.var_503);
         }
      }
   }
}

package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingView implements IInventoryView, IGetImageListener
   {
      ...
      private static const const_837:uint = 4284532064;
      
      private static const const_836:uint = 2577770;
      
      public static const const_1078:int = 0;
      ...
      private var var_1504:IWindowContainer;
      
      private var var_181:Timer;
      
      private var var_796:GroupItem;
      ...
      public function TradingView(param1:TradingModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IRoomEngine, param5:IHabboLocalizationManager)
      {
         ...
         this.var_361 = new ItemPopupCtrl(_loc8_,this._assetLibrary);
      }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this.var_181)
            {
               this.var_181.removeEventListener(TimerEvent.TIMER,this.timerEventHandler);
               this.var_181.stop();
               this.var_181 = null;
            }
      ...
      public function getWindowContainer() : IWindowContainer
      {
         ...
         {
            this.var_1504 = this.createMinimizedWindow();
         }
         if(!this.var_2072)
         {
            return this.var_64;
      ...
      public function updateUserInterface() : void
      {
         ...
         if(this.var_64)
         {
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.ownUserAccepts ? uint(const_837) : uint(const_836);
            }
            ...
            if(_loc1_)
            {
               _loc1_.color = !!this.var_22.otherUserAccepts ? uint(const_837) : uint(const_836);
            }
         ...
         if(this.var_64)
         {
            ...
            switch(this.var_22.state)
            {
               ...
               case TradingModel.const_264:
                  ...
                  this.showInfoMessage("${inventory.trading.info.confirm}");
                  break;
               case TradingModel.const_487:
                  _loc1_.disable();
                  this.showInfoMessage("${inventory.trading.info.waiting}");
                  break;
               case TradingModel.const_254:
                  _loc1_.disable();
                  _loc1_.caption = "${inventory.trading.accept}";
                  this.showInfoMessage("${inventory.trading.info.confirm}");
                  break;
      ...
      public function startConfirmCountdown() : void
      {
         ...
         {
            this.var_181 = new Timer(1000,3);
            this.var_181.addEventListener(TimerEvent.TIMER,this.timerEventHandler);
         }
         this.var_181.reset();
         this.var_181.repeatCount = 3;
         this.var_181.start();
      ...
      {
         this._windowManager.registerLocalizationParameter("inventory.trading.countdown","counter",String(3 - this.var_181.currentCount));
         if(this.var_181.currentCount == 3)
         {
      ...
      private function ownThumbEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER)
         {
            ...
            if(_loc4_.category == FurniCategory.const_143)
            {
               _loc6_ = "${poster_" + _loc4_.stuffData + "_name}";
            }
            if(_loc4_.category == FurniCategory.const_1028)
            {
            ...
            this.var_361.updateContent(param2 as IWindowContainer,_loc6_,_loc5_,ItemPopupCtrl.const_407);
            this.var_361.show();
         }
         else if(param1.type == WindowMouseEvent.const_25)
         {
            this.var_361.hideDelayed();
         }
      }

package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_330:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog)
      {
         ...
         this.var_551 = new Timer(const_1163,1);
         this.var_551.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc8_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc9_:XmlAsset = XmlAsset(_loc8_);
         this.var_2145 = XML(_loc9_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._roomEngine != null)
            {
               ...
               {
                  this._roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_204,this.onObjectPlaced);
               }
            ...
            {
               this.var_551.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_551.stop();
               this.var_551 = null;
            }
            if(this.var_182 != null)
            {
               this.var_182.removeEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
               this.var_182.stop();
               this.var_182 = null;
            }
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         var _loc8_:* = null;
         var _loc9_:* = null;
         if(param3 == FurniCategory.const_345)
         {
         ...
         else if(param3 == FurniCategory.const_367)
         {
         ...
         if(this.var_819 == null)
         {
            this.var_819 = this._windowManager.buildFromXML(this.var_2145) as IWindowContainer;
         }
         var _loc11_:IWindowContainer = this.var_819.clone() as IWindowContainer;
      ...
      public function requestInitialization(param1:int = 0) : void
      {
         if(param1 > 0)
         {
            ...
            this.var_182 = new Timer(param1,1);
            this.var_182.addEventListener(TimerEvent.TIMER_COMPLETE,this.initTimeout);
            this.var_182.start();
         }
         else
         {
         ...
         if(param1 == InventoryCategory.const_79 && this._controller.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_45:
                  ...
                  break;
               case const_330:
                  this._controller.toggleInventoryPage(InventoryCategory.const_159);
            }
         }
      }
      ...
      {
         this._controller.checkCategoryInitilization(InventoryCategory.const_321);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_446.add(const_40,new Array());
         this.var_446.add(const_45,new Array());
         if(this._view != null)
         {
      ...
      public function addFurniAt(param1:IItem, param2:Boolean = false, param3:int = -1) : void
      {
         ...
         else
         {
            ...
            for(; _loc8_ < _loc6_.length; _loc8_++)
            {
               ...
               if(_loc7_.type == param1.type)
               {
                  if(param1.category != FurniCategory.const_143)
                  {
                     _loc5_ = _loc7_;
                  }
      ...
      {
         return this._controller.getSubCategoryViewId() == InventorySubCategory.const_284;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_373 || _loc3_.category == FurniCategory.const_345 || _loc3_.category == FurniCategory.const_367)
         {
            if(param1)
            {
               return false;
      ...
      {
         if(this.var_1261 && param1.type == RoomEngineObjectEvent.const_204)
         {
            this.var_1261 = false;
         }
      }
      ...
      {
         return this.var_446.getValue(param1);
      }
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_284:
               ...
               break;
            case InventorySubCategory.const_953:
               this.removeAllLocks();
               if(this._view != null)
               {
                  this._view.updateActionView();
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = this.var_446.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = this.var_446.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
               while(_loc5_ < _loc4_.length)
               {
                  ...
                  if(_loc6_.category == FurniCategory.const_789)
                  {
                     _loc7_ = 1;
                  }
                  _loc8_ = 0;

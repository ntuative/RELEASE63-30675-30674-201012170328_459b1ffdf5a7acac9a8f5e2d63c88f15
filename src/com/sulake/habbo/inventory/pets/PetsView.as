package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener
   {
      ...
      private var var_63:PetsModel;
      
      private var _disposed:Boolean = false;
      
      private var var_473:IItemGridWindow;
      
      private var _avatarRenderer:IAvatarRenderManager;
      
      private var var_584:Map;
      
      private var var_321:PetsGridItem;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IAvatarRenderManager)
      {
         ...
         this.var_473 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      {
         this.updateGrid();
         this.updatePreview(this.var_321);
      }
      ...
      public function removePet(param1:int) : void
      {
         ...
         this.var_473.removeGridItem(_loc2_.window);
         if(this.var_321 == _loc2_)
         {
            this.var_321 = null;
            this.selectFirst();
         }
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_473.addGridItem(_loc2_.window);
      ...
      private function updateGrid() : void
      {
         ...
         this.var_473.removeGridItems();
         this.var_584.reset();
         var _loc1_:Map = this.var_63.pets;
         if(_loc1_ == null)
         {
            return;
         }
      ...
      private function placeButtonClickHandler(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:PetData = this.var_321.pet;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      {
         this.var_63.placePetToRoom(param1,param2);
      }
      ...
      private function windowEventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         if(param1.type == WindowEvent.const_57)
         {
            ...
            {
               case "tab_floor":
                  this.var_63.switchCategory(FurniModel.const_40);
                  break;
               case "tab_wall":
                  this.var_63.switchCategory(FurniModel.const_45);
            }
            this.selectPetsTab();
         }
      }
      ...
      public function setSelectedGridItem(param1:PetsGridItem) : void
      {
         if(this.var_321 != null)
         {
            this.var_321.setSelected(false);
         }
         this.var_321 = param1;
         if(this.var_321 != null)
         {
            this.var_321.setSelected(true);
         }
      ...
      private function updatePreview(param1:PetsGridItem = null) : void
      {
         ...
         if(this.var_63.roomSession != null)
         {
            _loc8_ = this.var_63.roomSession.arePetsAllowed;
            _loc9_ = this.var_63.roomSession.isRoomOwner;
         }
         var _loc10_:String = "";
         if(!_loc9_)
         {

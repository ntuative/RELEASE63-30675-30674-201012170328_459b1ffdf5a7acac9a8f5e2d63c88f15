package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1475:int = 16777215;
      
      public static const const_1350:int = 13421772;
      ...
      public static const const_1439:int = 16777215;
      
      public static const const_1385:int = 13421772;
      
      public static const const_1316:int = 10066329;
      ...
      private var var_656:Rectangle = null;
      
      private var var_437:RoomPlaneBitmapMaskParser = null;
      ...
      private var var_992:uint = 16777215;
      
      private var var_2095:int = 255;
      
      private var var_2094:int = 255;
      
      private var var_2098:int = 255;
      ...
      private const const_1826:int = 250;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_437 = new RoomPlaneBitmapMaskParser();
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_656 = super.boundingRectangle;
         }
         return new Rectangle(this.var_656.x,this.var_656.y,this.var_656.width,this.var_656.height);
      }
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_1102);
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1094);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            if(_loc12_ == RoomPlaneData.const_184)
            {
               ...
               if(_loc14_.z != 0)
               {
                  _loc13_.color = const_1475;
               }
               else
               {
                  _loc13_.color = const_1350;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_1442)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_105,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean) : void
      {
         ...
         if(_loc8_ < this._lastUpdateTime + this.const_1826 && !_loc5_ && !_loc7_)
         {
            return;
         }
         ...
         {
            _loc9_ = 0;
            while(_loc9_ < this.var_304.length)
            {
               _loc10_ = this.var_543[_loc9_];
               _loc11_ = getSprite(_loc10_);
               _loc12_ = this.var_304[_loc9_] as RoomPlane;
               if(_loc11_ != null && _loc12_ != null && _loc12_.type != RoomPlane.const_87)
               {
                  if(this.var_1517)
                  {
                     _loc13_ = uint(_loc12_.color);
                     _loc14_ = uint((_loc13_ & 255) * this.var_2098 / 255);
                     _loc15_ = uint((_loc13_ >> 8 & 255) * this.var_2094 / 255);
                     _loc16_ = uint((_loc13_ >> 16 & 255) * this.var_2095 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1463)
         {
            ...
            if(_loc3_ != null && (_loc3_.x != this.var_1212 || _loc3_.y != this.var_1998 || _loc3_.z != this.var_2000 || param1.scale != this.var_1997))
            {
               this.var_1212 = _loc3_.x;
               this.var_1998 = _loc3_.y;
               this.var_2000 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_920);
            if(_loc3_ != this.var_2097)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2097 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_606));
            if(_loc4_ != this.var_992)
            {
               this.var_992 = _loc4_;
               this.var_2098 = this.var_992 & 255;
               this.var_2094 = this.var_992 >> 8 & 255;
               this.var_2095 = this.var_992 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1036));
            if(_loc5_ != this.var_1517)
            {
               this.var_1517 = _loc5_;
               _loc2_ = true;
            }
         }
         return _loc2_;
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_216 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_794);
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_673);
            _loc4_ = param1.getString(RoomObjectVariableEnum.const_630);
            this.updatePlaneTextureTypes(_loc3_,_loc2_,_loc4_);
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_738));
            _loc6_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_569));
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_575));
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_304;
         if(this.var_304.length == 0)
         {
            _loc6_ = this.var_125;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_304.length > 0;
         var _loc9_:int = 0;
            ...
            if(_loc11_ != null)
            {
               ...
               if(_loc12_ != null)
               {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_304.push(_loc12_);
                        this.var_543.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1516;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_437.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_437.maskCount)
         {
            _loc10_ = this.var_437.getMaskType(_loc8_);
            _loc11_ = this.var_437.getMaskLocation(_loc8_);
            _loc12_ = this.var_437.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_125.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_105 || _loc3_.type == RoomPlane.const_87)
                  {
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_105 || _loc3_.type == RoomPlane.const_87 && _loc12_ == RoomPlaneBitmapMaskData.const_232)
                              {

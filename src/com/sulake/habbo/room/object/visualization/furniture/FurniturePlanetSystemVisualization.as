      ...
      override protected function updateAnimation(param1:Number) : Array
      {
         ...
         if(this.var_235 != null)
         {
            ...
            while(_loc3_ < this.var_235.length)
            {
               ...
               _loc2_.update(this._offsetArray,this.var_2241,param1);
               _loc3_++;
            }

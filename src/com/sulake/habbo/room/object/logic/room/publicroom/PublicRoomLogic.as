package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_362,"");
         _loc2_.setString(RoomObjectVariableEnum.const_708,"");
      ...
      {
         super.update(param1);
         if(this.var_1253 > 0 && param1 > this.var_1253)
         {
            this.adDelayTimeout();
            this.var_1253 = 0;
         }
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_958:
                  _loc2_.setString(RoomObjectVariableEnum.const_362,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_708,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_406,Number(true));
                  this.var_1253 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_886);
            }
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               if(_loc3_.spriteTag == RoomObjectVariableEnum.const_530)
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_708);
                  if(_loc7_ != null && _loc7_.indexOf("http") == 0)
                  {
                     eventDispatcher.dispatchEvent(new RoomObjectRoomAdEvent(RoomObjectRoomAdEvent.const_296,_loc5_,_loc6_,_loc7_));

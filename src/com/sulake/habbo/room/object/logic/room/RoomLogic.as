package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1538:int = 255;
      
      private var var_1246:uint = 16777215;
      
      private var var_1539:int = 255;
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1102,param1.toString(),true);
            _loc2_.setNumber(RoomObjectVariableEnum.const_606,16777215);
            _loc2_.setNumber(RoomObjectVariableEnum.const_738,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_569,1);
            _loc2_.setNumber(RoomObjectVariableEnum.const_575,1);
         }
      }
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1000)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1538;
            if(_loc2_ - this.var_1000 >= this.var_1541)
            {
               _loc3_ = this.var_1001;
               _loc4_ = this.var_1540;
               this.var_1000 = 0;
            }
            else
            {
               _loc7_ = this.var_1246 >> 16 & 255;
               _loc8_ = this.var_1246 >> 8 & 255;
               _loc9_ = this.var_1246 & 255;
               _loc10_ = this.var_1001 >> 16 & 255;
               _loc11_ = this.var_1001 >> 8 & 255;
               _loc12_ = this.var_1001 & 255;
               _loc13_ = (_loc2_ - this.var_1000) / this.var_1541;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1539 + (this.var_1540 - this.var_1539) * _loc13_;
               this._color = _loc3_;
               this.var_1538 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_606,_loc3_);
         }
      }
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomUpdateMessage.const_566:
               param2.setString(RoomObjectVariableEnum.const_673,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_716:
               param2.setString(RoomObjectVariableEnum.const_794,param1.value);
               break;
            case RoomObjectRoomUpdateMessage.const_815:
               param2.setString(RoomObjectVariableEnum.const_630,param1.value);
         }
      }
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_454:
               _loc5_ = "null";
               if(param1.maskCategory == RoomObjectRoomMaskUpdateMessage.const_232)
               {
                  _loc5_ = "null";
               }
               this.var_437.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_734:
               _loc4_ = this.var_437.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_437.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_920,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1095:
               param2.setNumber(RoomObjectVariableEnum.const_738,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1014:
               param2.setNumber(RoomObjectVariableEnum.const_569,_loc3_);
               param2.setNumber(RoomObjectVariableEnum.const_575,_loc3_);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         param2.setNumber(RoomObjectVariableEnum.const_1036,int(param1.bgOnly));
         this.var_1246 = this._color;
         this.var_1539 = this.var_1538;
         this.var_1001 = _loc3_;
         this.var_1540 = _loc4_;
         this.var_1000 = getTimer();
         this.var_1541 = 1500;
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > this._planeParser.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_540,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1496,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1251,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1305,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_540,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  {
                     if(_loc13_ == RoomPlaneData.const_184)
                     {
                        _loc25_ = new RoomObjectTileMouseEvent(_loc26_,param1.eventId,_loc24_,_loc23_,_loc20_,_loc21_,_loc22_);
                     }
                     else if(_loc13_ == RoomPlaneData.const_149 || _loc13_ == RoomPlaneData.const_277)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {

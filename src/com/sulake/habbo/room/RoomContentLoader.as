package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      public static const const_746:String = "RCL_LOADER_READY";
      ...
      private static const const_385:String = "place_holder";
      
      private static const const_545:String = "wall_place_holder";
      
      private static const const_1132:String = const_385;
      ...
      private var var_1200:IEventDispatcher = null;
      ...
      private var var_1201:Map = null;
      
      private var var_525:Map = null;
      
      private var var_425:Map = null;
      ...
      public function RoomContentLoader()
      {
         this.var_526 = [];
         this._wallItems = [];
         this.var_1972 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_1966 = ["room_public","room_public_park","room_public_pool"];
         super();
         ...
         this.var_354 = new Map();
         this.var_635 = new Map();
      ...
      {
         if(this._state >= const_826)
         {
            return;
         }
         this.var_1200 = param1;
         this.var_1971 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_1970 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
         this.var_1967 = param2.getKey("public.room.dynamic.download.url","");
         this.var_1969 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         this._state = const_826;
         this.initFurniData();
      }
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_424.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc3_ = this.var_424.getWithIndex(_loc2_) as AssetLibrary;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
         ...
         {
            _loc1_ = this.var_354.length;
            _loc2_ = 0;
            while(_loc2_ < _loc1_)
            {
               _loc4_ = this.var_354.getWithIndex(_loc2_) as IGraphicAssetCollection;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            if(_loc6_.length > 0)
            {
               this.var_634.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_527.add(_loc3_,_loc4_);
               if(this.var_526.indexOf(_loc7_) < 0)
               {
            ...
            else if(_loc2_.type == "i")
            {
               ...
               this.var_524.add(_loc3_,_loc4_);
               if(this._wallItems.indexOf(_loc7_) < 0)
               {
                  this._wallItems.push(_loc7_);
               }
            }
            _loc8_ = this.var_525.getValue(_loc7_);
            if(_loc5_ > _loc8_)
            {
               this.var_525.remove(_loc7_);
               this.var_525.add(_loc7_,_loc5_);
            }
         }
      }
      ...
      private function continueInitilization() : void
      {
         if(this.var_1968)
         {
            ...
            {
               this.var_1200.dispatchEvent(new Event(const_746));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_425 != null)
         {
            this.var_425.remove(param1);
            this.var_425.add(param1,param2);
         }
         if(this.var_423 != null)
         {
            this.var_423.remove(param2);
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(this.var_425 != null)
         {
            _loc2_ = this.var_425.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function getRoomObjectOriginalName(param1:String) : String
      {
         ...
         if(this.var_423 != null)
         {
            _loc2_ = this.var_423.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_526.indexOf(param1) >= 0)
         {
         ...
         if(this.var_176 != null && (this.var_176.type == param1 || this.var_176.hasWorldType(param1)))
         {
         ...
         {
            return RoomObjectCategoryEnum.const_300;
         }
         return RoomObjectCategoryEnum.const_152;
      }
      ...
      {
         return [const_385,const_545,ROOM_CONTENT,const_825,const_827];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_527.getValue(param1) as String;
         return this.getObjectType(_loc2_);
      }
      
      public function getWallItemType(param1:int, param2:String = null) : String
      {
         var _loc3_:String = this.var_524.getValue(param1) as String;
      ...
      {
         var _loc2_:String = this.var_524.getValue(param1) as String;
         return this.getObjectColorIndex(_loc2_);
      }
      
      public function getRoomObjectAdURL(param1:String) : String
      {
         if(this.var_634.getValue(param1) != null)
         {
            return this.var_634.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_176 != null && this.var_176.hasWorldType(const_310 + param1))
         {
            return this.var_176.type;
         }
         return param1;
      }
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_163 || param1 == RoomObjectVisualizationEnum.const_64 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE || _loc2_ == RoomObjectCategoryEnum.const_27)
         {
            ...
            return int(this.var_525.getValue(param1));
         }
         return 0;
      }
      ...
      private function getObjectContentURLs(param1:String) : Array
      {
         ...
         switch(_loc2_)
         {
            ...
            default:
               ...
               {
                  _loc10_ = this.var_1969;
                  _loc10_ = _loc10_.replace(/%typeid%/,_loc7_[_loc9_]);
                  _loc8_.push(this.var_1967 + _loc10_);
                  _loc9_++;
               }
               return _loc8_;
         }
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE:
                     if(this.var_526.indexOf(_loc4_) == -1)
                     {
                        this.var_526.push(_loc4_);
                     }
                     break;
                  case RoomObjectCategoryEnum.const_27:
               ...
               _loc6_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_366,_loc4_);
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1201.getValue(param1) != null)
         {
            this.var_176 = this.var_1201.getValue(param1) as PublicRoomData;
         }
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_599,this.onContentLoaded);
            _loc6_ = 0;
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_1972.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1444);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_1966.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
               _loc7_ = this.getVisualizationXML(_loc5_);
               _loc8_ = this.extractPublicRoomFromXML(_loc5_,_loc7_);
               this.var_1201.add(_loc5_,_loc8_);
               this.var_176 = _loc8_;
               this.extractPublicRoomFurnitures(_loc5_,_loc2_);
            }
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_366,_loc5_);
         }
         else
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_504,_loc5_);
         }
      ...
      public function extractObjectContent(param1:String, param2:String) : Boolean
      {
         ...
         this.var_635.add(param2,param1);
         if(this.initializeGraphicAssetCollection(param2,_loc3_))
         {
            return true;
         }
         this.var_635.remove(param2);
         return false;
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_424.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            _loc4_ = this.var_635.getValue(_loc2_);
            if(_loc4_ != null)
            {
               _loc2_ = this.getContentType(_loc4_);
               _loc3_ = this.var_424.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_424.add(_loc5_,_loc4_);
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_258 && _loc5_ != RoomObjectLogicEnum.const_163)
         {
            _loc6_ = "@shadow";
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_458.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
            _loc3_.assetLibrary = param2;
            this.var_354.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_354.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_354[_loc2_] != null)
         {
            _loc3_ = this.var_354.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_176.getWorldHeightScale(const_310 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_176 != null)
         {
            return this.var_176.getWorldScale(const_310 + param1);
         }
         return 32;
      }

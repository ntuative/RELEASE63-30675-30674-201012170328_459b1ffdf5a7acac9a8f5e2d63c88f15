package com.sulake.habbo.moderation
{
   ...
   public class IssueListView
   {
      ...
      private var var_1800:IWindowContainer;
      ...
      public function IssueListView(param1:IssueManager, param2:IssueBrowser, param3:IItemListWindow, param4:String)
      {
         ...
         this.var_567 = param2;
         this.var_54 = param3;
         this.var_1592 = param4;
         this.var_1800 = this.var_567.createWindow(param4) as IWindowContainer;
      }
      ...
      public function update(param1:Array) : void
      {
         ...
         for each(_loc5_ in param1)
         {
            ...
            if(_loc5_ == null || this.var_1800 == null)
            {
               return;
            }
            _loc2_ = this.var_1800.clone() as IWindowContainer;
            if(_loc2_ == null)
            {
               return;
            }
            _loc2_.width = this.var_54.width;
            ...
            if(_loc7_ != null)
            {
               ...
               _loc9_ = this.var_567.assets.getAssetByName(_loc8_) as BitmapDataAsset;

package com.sulake.habbo.moderation
{
   ...
   public class UserInfoFrameCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_950:UserInfoCtrl;
      ...
      public function show() : void
      {
         ...
         this.var_950 = new UserInfoCtrl(this._frame,this.var_47,"",true);
         this.var_950.load(this._frame.content,this._userId);
         this._frame.visible = true;
      }
      
      public function getType() : int
      {
         return WindowTracker.const_1498;
      }

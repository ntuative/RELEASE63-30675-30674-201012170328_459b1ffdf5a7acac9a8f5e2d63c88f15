package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_1844:String = "my_issues";
      
      private const const_1843:String = "open_issues";
      
      private const const_1842:String = "picked_issues";
      
      private const const_1852:String = "closed_issues";
      ...
      private var var_1737:IIssueBrowserView;
      
      private var var_1736:IIssueBrowserView;
      
      private var var_1738:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         if(this.var_326 == _loc2_)
         {
            return;
         }
         if(this.var_326 != null)
         {
            this.var_326.visible = false;
         }
         this.var_326 = _loc2_;
         if(this.var_326 == null)
         {
         ...
         this.var_326.view.width = this.var_240.container.width;
         this.var_326.view.height = this.var_240.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_1844:
               ...
               {
                  this.var_1737 = new MyIssuesView(this.issueManager,this,this.var_240.container);
               }
               return this.var_1737;
            case this.const_1843:
               if(this.var_1736 == null)
               {
                  this.var_1736 = new OpenIssuesView(this.issueManager,this,this.var_240.container);
               }
               return this.var_1736;
            case this.const_1842:
               if(this.var_1738 == null)
               {
                  this.var_1738 = new PickedIssuesView(this.issueManager,this,this.var_240.container);
               }

package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_430:UserInfoCtrl;
      
      private var var_969:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         if(this.var_60.windowManager == null || this.var_60.assets == null)
         {
            return;
         }
         var _loc1_:XmlAsset = this.var_60.assets.getAssetByName("issue_handler_xml") as XmlAsset;
         if(_loc1_ == null || _loc1_.content == null)
         {
            return;
         }
         this._window = this.var_60.windowManager.buildFromXML(_loc1_.content as XML) as IFrameWindow;
         if(this._window == null)
         {
            return;
         }
         ...
         this.var_60.disableButton(this.var_60.initMsg.chatlogsPermission,this._window,"show_chatlog");
         _loc2_ = this._window.findChildByName("move_to_player_support");
         if(_loc2_ != null)
         {
            _loc2_.disable();
         }
         var _loc3_:IssueMessageData = this.var_116.getHighestPriorityIssue();
         this.var_430 = new UserInfoCtrl(this._window,this.var_60,_loc3_.message);
         this.var_969 = new UserInfoCtrl(this._window,this.var_60,_loc3_.message);
         this.var_430.load(IWindowContainer(this._window.findChildByName("caller_user_info")),this.var_116.getHighestPriorityIssue().reporterUserId);
         var _loc4_:IWindowContainer = IWindowContainer(this._window.findChildByName("reported_user_info"));
         if(this.var_116.reportedUserId > 0)
         {
            this.var_969.load(_loc4_,this.var_116.reportedUserId);
         }
         else
         {
         ...
         Logger.log("HARASSER: " + this.var_116.reportedUserId);
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc2_:XmlAsset = this.var_60.assets.getAssetByName("issue_handler_issue_info_xml") as XmlAsset;
         if(_loc2_ == null || _loc2_.content == null)
         {
            return;
         }
         var _loc3_:IWindowContainer = this.var_60.windowManager.buildFromXML(_loc2_.content as XML) as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
         var _loc4_:Array = this.var_116.issues;
         var _loc5_:int = 0;
      ...
      private function updateMessages() : void
      {
         ...
         _loc1_.removeListItems();
         var _loc2_:XmlAsset = this.var_60.assets.getAssetByName("issue_handler_message_list_item_xml") as XmlAsset;
         if(_loc2_ == null || _loc2_.content == null)
         {
            return;
         }
         var _loc3_:ITextWindow = this.var_60.windowManager.buildFromXML(_loc2_.content as XML) as ITextWindow;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      {
         if(this.var_60 != null && this.var_60.issueManager != null && this.var_116 != null)
         {
            this.var_60.issueManager.removeHandler(this.var_116.id);
         }
         this.dispose();
      }
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         this.var_60.issueManager.closeBundle(this.var_116.id,1);
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         this.var_60.issueManager.closeBundle(this.var_116.id,2);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         this.var_60.issueManager.closeBundle(this.var_116.id,3);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         this.var_60.issueManager.releaseBundle(this.var_116.id);
         this.checkAutoHandling();
         this.dispose();
      }
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = this.var_116.getHighestPriorityIssue().issueId;
         this.var_60.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_60,WindowTracker.const_949,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            _loc3_ = this.var_116.getHighestPriorityIssue();
            this.var_430 = new UserInfoCtrl(this._window,this.var_60,_loc3_.message);
            this.var_430.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      {
         if(this._window == null || this.var_60 == null || this.var_60.issueManager == null)
         {
            return;
         }
         ...
         {
            this.var_60.issueManager.autoPick();
         }
      }
   }
}

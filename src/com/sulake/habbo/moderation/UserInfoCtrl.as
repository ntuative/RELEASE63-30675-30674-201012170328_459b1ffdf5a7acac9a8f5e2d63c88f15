package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_850:int = 60;
      
      private static const const_848:int = 3600;
      
      private static const const_849:int = 86400;
      
      private static const const_851:int = 31536000;
      ...
      public function UserInfoCtrl(param1:IFrameWindow, param2:ModerationManager, param3:String, param4:Boolean = false)
      {
         ...
         this.var_47 = param2;
         this.var_1224 = param3;
         this.var_1058 = param4;
      }
      
      public static function formatTime(param1:int) : String
      {
         if(param1 < 2 * const_850)
         {
            return param1 + " secs ago";
         }
         if(param1 < 2 * const_848)
         {
            return Math.round(param1 / const_850) + " mins ago";
         }
         if(param1 < 2 * const_849)
         {
            return Math.round(param1 / const_848) + " hours ago";
         }
         if(param1 < 2 * const_851)
         {
            return Math.round(param1 / const_849) + " days ago";
         }
         return Math.round(param1 / const_851) + " years ago";
      }
      ...
      {
         var _loc1_:IWindowContainer = IWindowContainer(this.var_1059.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(this.var_47.getXmlWindow("user_info"));
            this.var_1059.addChild(_loc1_);
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_47.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(this._data.userId),this.var_47,WindowTracker.const_905,this._data.userId),this._callerFrame,this.var_1058,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_47.windowTracker.show(new RoomVisitsCtrl(this.var_47,this._data.userId),this._callerFrame,this.var_1058,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_47.windowTracker.show(new SendMsgsCtrl(this.var_47,this._data.userId,this._data.userName,this.var_1224),this._callerFrame,this.var_1058,false,true);
      }
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_47.windowTracker.show(new ModActionCtrl(this.var_47,this._data.userId,this._data.userName,this.var_1224),this._callerFrame,this.var_1058,false,true);
      }

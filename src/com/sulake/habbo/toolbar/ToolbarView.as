package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private var var_447:String = "LEFT";
      
      private var var_137:Number = 50;
      
      private var var_1015:Boolean = true;
      
      private var var_1014:Number = 1;
      
      private var var_1264:Number = 0;
      
      private var var_1576:Number = 15;
      
      private var var_1577:Number = 5;
      
      public function ToolbarView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher)
      {
         this.var_2650 = new Array();
         this.var_225 = new Array();
         this.var_553 = new Array();
         super();
         this._events = param3;
         ...
         this.var_195 = param1.createWindow("extrabar_container_window","",HabboWindowType.const_56,HabboWindowStyle.const_902,0 | 0,new Rectangle(0,0,1,1),null,0,0) as IWindowContainer;
         ...
         this.var_1015 = String(_loc6_.relocate_by_drag.@state) == "true";
         if(this.var_1015)
         {
         ...
         this.var_1014 = _loc6_.toolbar.@margin_top;
         this.var_1264 = _loc6_.toolbar.@margin_bottom;
         this.var_1576 = _loc6_.toolbar.@min_group_margin;
         this.var_1577 = _loc6_.toolbar.@margin_to_extrabar;
         this.var_286 = new ToolbarBarMenuAnimator(param1,this);
         var _loc7_:XMLList = XMLList(_loc6_.toolbar).children();
         var _loc8_:XMLList = XMLList(_loc6_.extras).children();
         this.createGroupsFromXmlList(_loc7_,this.var_225,param1,param2,this._window,this.var_286);
         this.createGroupsFromXmlList(_loc8_,this.var_553,param1,param2,this.var_195,this.var_286);
         this.alignWindows();
      }
      ...
      public function dispose() : void
      {
         ...
         while(this.var_553.length > 0)
         {
            _loc1_ = this.var_553.shift();
            _loc1_.dispose();
            _loc1_ = null;
         }
         if(this._window != null)
      ...
      public function animateWindowIn(param1:String, param2:IWindowContainer, param3:Point = null) : void
      {
         ...
         if(_loc4_ != null)
         {
            _loc4_.animateWindowIn(param1,param2,this.var_137,this.var_447,param3);
         }
      }
      ...
      public function animateWindowOut(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.animateWindowOut(param1,param2,this.var_447);
         }
      }
      ...
      public function positionWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.positionWindow(param1,param2,this.var_137,this.var_447);
         }
      }
      ...
      public function hideWindow(param1:String, param2:IWindowContainer) : void
      {
         ...
         if(_loc3_ != null)
         {
            _loc3_.hideWindow(param1,param2,this.var_137,this.var_447);
         }
      }
      ...
      private function getGroupForIcon(param1:String) : ToolbarIconGroup
      {
         ...
         _loc3_ = 0;
         while(_loc3_ < this.var_553.length)
         {
            _loc2_ = this.var_553[_loc3_];
            if(_loc2_.acceptsIcon(param1))
            {
               return _loc2_;
            }
      ...
      private function alignWindows() : void
      {
         ...
         switch(this.orientation)
         {
            case "LEFT":
               ...
               this._window.x = 0;
               this._window.y = 0;
               this.var_195.x = this.var_137 + this.var_1577;
               this.var_195.y = 0;
            ...
            case "TOP":
               ...
               this._window.y = 0;
               this.var_195.x = 0;
               this.var_195.y = this.var_137 + this.var_1577;
         ...
         _loc4_ -= this.var_1264;
         _loc4_ -= this.var_1014;
         var _loc5_:* = 0;
         _loc2_ = 0;
         while(_loc2_ < this.var_225.length)
         {
            _loc3_ = this.var_225[_loc2_];
            _loc5_ += _loc3_.iconCount * _loc3_.defaultIconSize;
            _loc2_++;
         }
         var _loc6_:* = 0;
         var _loc7_:Number = this.var_1014;
         var _loc8_:* = 1;
         if(_loc5_ > _loc4_)
         {
         ...
         else
         {
            ...
            if(this.var_225.length > 1)
            {
               if(this.orientation == "LEFT" || this.orientation == "RIGHT")
               {
                  _loc6_ = Number(Math.max(this.var_1576,(this._window.height - _loc5_ * _loc8_ - this.var_1014 - this.var_1264) / (this.var_225.length - 1)));
               }
               else
               {
                  _loc6_ = Number(Math.max(this.var_1576,(this._window.width - _loc5_ * _loc8_ - this.var_1014 - this.var_1264) / (this.var_225.length - 1)));
               }
            }
         }
         _loc2_ = 0;
         while(_loc2_ < this.var_225.length)
         {
            ...
            if(_loc3_ != null)
            {
               _loc3_.orientation = this.var_447;
         ...
         _loc2_ = 0;
         while(_loc2_ < this.var_553.length)
         {
            _loc3_ = this.var_553[_loc2_];
            if(_loc3_ != null)
            {
